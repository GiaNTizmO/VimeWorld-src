...
public class ItemInWorldManager
{
    ...
    public void setGameType(GameType type)
    {
        ...
        this.thisPlayerMP.mcServer.getConfigurationManager().sendPacketToAllPlayers(new S38PacketPlayerListItem(Action.UPDATE_GAME_MODE, new EntityPlayerMP[] {this.thisPlayerMP}));
    }
    ...
    {
        CamEventHandler.onPlayerInteract(this.thisPlayerMP, com.creativemd.cmdcam.CamEventHandler.Action.LEFT_CLICK_BLOCK, this.theWorld, pos, side);
    ...
    public boolean activateBlockOrUseItem(EntityPlayer player, World worldIn, ItemStack stack, BlockPos pos, EnumFacing side, float offsetX, float offsetY, float offsetZ)
    {
        ...
        {
            CamEventHandler.onPlayerInteract(player, com.creativemd.cmdcam.CamEventHandler.Action.RIGHT_CLICK_BLOCK, worldIn, pos, side);

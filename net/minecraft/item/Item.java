...
import net.minecraft.item.Item.11;
import net.minecraft.item.Item.12;
import net.minecraft.item.Item.13;
import net.minecraft.item.Item.14;
...
public class Item
{
    ...
    {
        registerItemBlock(Blocks.stone, (new ItemMultiTexture(Blocks.stone, Blocks.stone, new 1())).b("stone"));
        registerItemBlock(Blocks.grass, new ItemColored(Blocks.grass, false));
        registerItemBlock(Blocks.dirt, (new ItemMultiTexture(Blocks.dirt, Blocks.dirt, new 2())).b("dirt"));
        registerItemBlock(Blocks.cobblestone);
        registerItemBlock(Blocks.planks, (new ItemMultiTexture(Blocks.planks, Blocks.planks, new 3())).b("wood"));
        registerItemBlock(Blocks.sapling, (new ItemMultiTexture(Blocks.sapling, Blocks.sapling, new 4())).b("sapling"));
        registerItemBlock(Blocks.bedrock);
        registerItemBlock(Blocks.sand, (new ItemMultiTexture(Blocks.sand, Blocks.sand, new 5())).b("sand"));
        ...
        registerItemBlock(Blocks.log, (new ItemMultiTexture(Blocks.log, Blocks.log, new 6())).b("log"));
        registerItemBlock(Blocks.log2, (new ItemMultiTexture(Blocks.log2, Blocks.log2, new 7())).b("log"));
        ...
        registerItemBlock(Blocks.sponge, (new ItemMultiTexture(Blocks.sponge, Blocks.sponge, new 8())).b("sponge"));
        ...
        registerItemBlock(Blocks.sandstone, (new ItemMultiTexture(Blocks.sandstone, Blocks.sandstone, new 9())).b("sandStone"));
        ...
        registerItemBlock(Blocks.wool, (new ItemCloth(Blocks.wool)).b("cloth"));
        registerItemBlock(Blocks.yellow_flower, (new ItemMultiTexture(Blocks.yellow_flower, Blocks.yellow_flower, new 10())).b("flower"));
        registerItemBlock(Blocks.red_flower, (new ItemMultiTexture(Blocks.red_flower, Blocks.red_flower, new 11())).b("rose"));
        ...
        registerItemBlock(Blocks.stone_slab, (new ItemSlab(Blocks.stone_slab, Blocks.stone_slab, Blocks.double_stone_slab)).b("stoneSlab"));
        ...
        registerItemBlock(Blocks.monster_egg, (new ItemMultiTexture(Blocks.monster_egg, Blocks.monster_egg, new 12())).b("monsterStoneEgg"));
        registerItemBlock(Blocks.stonebrick, (new ItemMultiTexture(Blocks.stonebrick, Blocks.stonebrick, new 13())).b("stonebricksmooth"));
        ...
        registerItemBlock(Blocks.wooden_slab, (new ItemSlab(Blocks.wooden_slab, Blocks.wooden_slab, Blocks.double_wooden_slab)).b("woodSlab"));
        ...
        registerItemBlock(Blocks.cobblestone_wall, (new ItemMultiTexture(Blocks.cobblestone_wall, Blocks.cobblestone_wall, new 14())).b("cobbleWall"));
        registerItemBlock(Blocks.wooden_button);
        registerItemBlock(Blocks.anvil, (new ItemAnvilBlock(Blocks.anvil)).b("anvil"));
        ...
        registerItemBlock(Blocks.stained_hardened_clay, (new ItemCloth(Blocks.stained_hardened_clay)).b("clayHardenedStained"));
        registerItemBlock(Blocks.barrier);
        registerItemBlock(Blocks.iron_trapdoor);
        registerItemBlock(Blocks.hay_block);
        registerItemBlock(Blocks.carpet, (new ItemCloth(Blocks.carpet)).b("woolCarpet"));
        ...
        registerItemBlock(Blocks.double_plant, (new ItemDoublePlant(Blocks.double_plant, Blocks.double_plant, new 15())).b("doublePlant"));
        registerItemBlock(Blocks.stained_glass, (new ItemCloth(Blocks.stained_glass)).b("stainedGlass"));
        registerItemBlock(Blocks.stained_glass_pane, (new ItemCloth(Blocks.stained_glass_pane)).b("stainedGlassPane"));
        registerItemBlock(Blocks.prismarine, (new ItemMultiTexture(Blocks.prismarine, Blocks.prismarine, new 16())).b("prismarine"));
        registerItemBlock(Blocks.sea_lantern);
        registerItemBlock(Blocks.red_sandstone, (new ItemMultiTexture(Blocks.red_sandstone, Blocks.red_sandstone, new 17())).b("redSandStone"));
        registerItemBlock(Blocks.red_sandstone_stairs);
        registerItemBlock(Blocks.stone_slab2, (new ItemSlab(Blocks.stone_slab2, Blocks.stone_slab2, Blocks.double_stone_slab2)).b("stoneSlab2"));
        registerItemBlock(Blocks.purpur_block);
        registerItemBlock(Blocks.purpur_pillar);
        registerItemBlock(Blocks.purpur_stairs);
        registerItemBlock(Blocks.purpur_slab, (new ItemSlab(Blocks.purpur_slab, Blocks.purpur_slab, Blocks.purpur_double_slab)).b("purpurSlab"));
        ...
        registerItemBlock(Blocks.concrete, (new ItemCloth(Blocks.concrete)).b("concrete"));
        registerItemBlock(Blocks.concrete_powder, (new ItemCloth(Blocks.concrete_powder)).b("concretePowder"));
        registerItemBlock(Blocks.crimson_nylium);
        registerItemBlock(Blocks.warped_nylium);
        registerItemBlock(Blocks.crimson_stairs);
        registerItemBlock(Blocks.warped_stairs);
        registerItemBlock(Blocks.log_stripped1, (new ItemMultiTexture(Blocks.log_stripped1, Blocks.log_stripped1, new Function<ItemStack, String>()
        {
        ...
        registerItemBlock(Blocks.log_stripped2, (new ItemMultiTexture(Blocks.log_stripped2, Blocks.log_stripped2, new Function<ItemStack, String>()
        {
            public String apply(ItemStack p_apply_1_)
            {
        ...
        registerItemBlock(Blocks.lucky_block);
        registerItem(256, "iron_shovel", (new ItemSpade(Item.ToolMaterial.IRON)).c("shovelIron"));
        registerItem(257, "iron_pickaxe", (new ItemPickaxe(Item.ToolMaterial.IRON)).c("pickaxeIron"));
        registerItem(258, "iron_axe", (new ItemAxe(Item.ToolMaterial.IRON)).c("hatchetIron"));
        registerItem(259, "flint_and_steel", (new ItemFlintAndSteel()).c("flintAndSteel"));
        ...
        registerItem(267, "iron_sword", (new ItemSword(Item.ToolMaterial.IRON)).c("swordIron"));
        registerItem(268, "wooden_sword", (new ItemSword(Item.ToolMaterial.WOOD)).c("swordWood"));
        registerItem(269, "wooden_shovel", (new ItemSpade(Item.ToolMaterial.WOOD)).c("shovelWood"));
        registerItem(270, "wooden_pickaxe", (new ItemPickaxe(Item.ToolMaterial.WOOD)).c("pickaxeWood"));
        registerItem(271, "wooden_axe", (new ItemAxe(Item.ToolMaterial.WOOD)).c("hatchetWood"));
        registerItem(272, "stone_sword", (new ItemSword(Item.ToolMaterial.STONE)).c("swordStone"));
        registerItem(273, "stone_shovel", (new ItemSpade(Item.ToolMaterial.STONE)).c("shovelStone"));
        registerItem(274, "stone_pickaxe", (new ItemPickaxe(Item.ToolMaterial.STONE)).c("pickaxeStone"));
        registerItem(275, "stone_axe", (new ItemAxe(Item.ToolMaterial.STONE)).c("hatchetStone"));
        registerItem(276, "diamond_sword", (new ItemSword(Item.ToolMaterial.EMERALD)).c("swordDiamond"));
        registerItem(277, "diamond_shovel", (new ItemSpade(Item.ToolMaterial.EMERALD)).c("shovelDiamond"));
        registerItem(278, "diamond_pickaxe", (new ItemPickaxe(Item.ToolMaterial.EMERALD)).c("pickaxeDiamond"));
        registerItem(279, "diamond_axe", (new ItemAxe(Item.ToolMaterial.EMERALD)).c("hatchetDiamond"));
        ...
        registerItem(283, "golden_sword", (new ItemSword(Item.ToolMaterial.GOLD)).c("swordGold"));
        registerItem(284, "golden_shovel", (new ItemSpade(Item.ToolMaterial.GOLD)).c("shovelGold"));
        registerItem(285, "golden_pickaxe", (new ItemPickaxe(Item.ToolMaterial.GOLD)).c("pickaxeGold"));
        registerItem(286, "golden_axe", (new ItemAxe(Item.ToolMaterial.GOLD)).c("hatchetGold"));
        registerItem(287, "string", (new ItemReed(Blocks.tripwire)).c("string").setCreativeTab(CreativeTabs.tabMaterials));
        ...
        registerItem(290, "wooden_hoe", (new ItemHoe(Item.ToolMaterial.WOOD)).c("hoeWood"));
        registerItem(291, "stone_hoe", (new ItemHoe(Item.ToolMaterial.STONE)).c("hoeStone"));
        registerItem(292, "iron_hoe", (new ItemHoe(Item.ToolMaterial.IRON)).c("hoeIron"));
        registerItem(293, "diamond_hoe", (new ItemHoe(Item.ToolMaterial.EMERALD)).c("hoeDiamond"));
        registerItem(294, "golden_hoe", (new ItemHoe(Item.ToolMaterial.GOLD)).c("hoeGold"));
        ...
        registerItem(298, "leather_helmet", (new ItemArmor(ArmorMaterial.LEATHER, 0, 0)).c("helmetCloth"));
        registerItem(299, "leather_chestplate", (new ItemArmor(ArmorMaterial.LEATHER, 0, 1)).c("chestplateCloth"));
        registerItem(300, "leather_leggings", (new ItemArmor(ArmorMaterial.LEATHER, 0, 2)).c("leggingsCloth"));
        registerItem(301, "leather_boots", (new ItemArmor(ArmorMaterial.LEATHER, 0, 3)).c("bootsCloth"));
        registerItem(302, "chainmail_helmet", (new ItemArmor(ArmorMaterial.CHAIN, 1, 0)).c("helmetChain"));
        registerItem(303, "chainmail_chestplate", (new ItemArmor(ArmorMaterial.CHAIN, 1, 1)).c("chestplateChain"));
        registerItem(304, "chainmail_leggings", (new ItemArmor(ArmorMaterial.CHAIN, 1, 2)).c("leggingsChain"));
        registerItem(305, "chainmail_boots", (new ItemArmor(ArmorMaterial.CHAIN, 1, 3)).c("bootsChain"));
        registerItem(306, "iron_helmet", (new ItemArmor(ArmorMaterial.IRON, 2, 0)).c("helmetIron"));
        registerItem(307, "iron_chestplate", (new ItemArmor(ArmorMaterial.IRON, 2, 1)).c("chestplateIron"));
        registerItem(308, "iron_leggings", (new ItemArmor(ArmorMaterial.IRON, 2, 2)).c("leggingsIron"));
        registerItem(309, "iron_boots", (new ItemArmor(ArmorMaterial.IRON, 2, 3)).c("bootsIron"));
        registerItem(310, "diamond_helmet", (new ItemArmor(ArmorMaterial.DIAMOND, 3, 0)).c("helmetDiamond"));
        registerItem(311, "diamond_chestplate", (new ItemArmor(ArmorMaterial.DIAMOND, 3, 1)).c("chestplateDiamond"));
        registerItem(312, "diamond_leggings", (new ItemArmor(ArmorMaterial.DIAMOND, 3, 2)).c("leggingsDiamond"));
        registerItem(313, "diamond_boots", (new ItemArmor(ArmorMaterial.DIAMOND, 3, 3)).c("bootsDiamond"));
        registerItem(314, "golden_helmet", (new ItemArmor(ArmorMaterial.GOLD, 4, 0)).c("helmetGold"));
        registerItem(315, "golden_chestplate", (new ItemArmor(ArmorMaterial.GOLD, 4, 1)).c("chestplateGold"));
        registerItem(316, "golden_leggings", (new ItemArmor(ArmorMaterial.GOLD, 4, 2)).c("leggingsGold"));
        registerItem(317, "golden_boots", (new ItemArmor(ArmorMaterial.GOLD, 4, 3)).c("bootsGold"));
        ...
        registerItem(321, "painting", (new ItemHangingEntity(EntityPainting.class)).c("painting"));
        registerItem(322, "golden_apple", (new ItemAppleGold(4, 1.2F, false)).h().setPotionEffect(Potion.regeneration.id, 5, 1, 1.0F).c("appleGold"));
        registerItem(323, "sign", (new ItemSign()).c("sign"));
        registerItem(324, "wooden_door", (new ItemDoor(Blocks.oak_door)).c("doorOak"));
        Item item = (new ItemBucket(Blocks.air)).c("bucket").setMaxStackSize(16);
        registerItem(325, "bucket", item);
        registerItem(326, "water_bucket", (new ItemBucket(Blocks.flowing_water)).c("bucketWater").setContainerItem(item));
        registerItem(327, "lava_bucket", (new ItemBucket(Blocks.flowing_lava)).c("bucketLava").setContainerItem(item));
        registerItem(328, "minecart", (new ItemMinecart(EnumMinecartType.RIDEABLE)).c("minecart"));
        registerItem(329, "saddle", (new ItemSaddle()).c("saddle"));
        registerItem(330, "iron_door", (new ItemDoor(Blocks.iron_door)).c("doorIron"));
        registerItem(331, "redstone", (new ItemRedstone()).c("redstone").setPotionEffect("-5+6-7"));
        ...
        registerItem(335, "milk_bucket", (new ItemBucketMilk()).c("milk").setContainerItem(item));
        ...
        registerItem(338, "reeds", (new ItemReed(Blocks.reeds)).c("reeds").setCreativeTab(CreativeTabs.tabMaterials));
        registerItem(339, "paper", (new Item()).setUnlocalizedName("paper").setCreativeTab(CreativeTabs.tabMisc));
        registerItem(340, "book", (new ItemBook()).c("book").setCreativeTab(CreativeTabs.tabMisc));
        registerItem(341, "slime_ball", (new Item()).setUnlocalizedName("slimeball").setCreativeTab(CreativeTabs.tabMisc));
        registerItem(342, "chest_minecart", (new ItemMinecart(EnumMinecartType.CHEST)).c("minecartChest"));
        registerItem(343, "furnace_minecart", (new ItemMinecart(EnumMinecartType.FURNACE)).c("minecartFurnace"));
        ...
        registerItem(349, "fish", (new ItemFishFood(false)).c("fish").setHasSubtypes(true));
        registerItem(350, "cooked_fish", (new ItemFishFood(true)).c("fish").setHasSubtypes(true));
        ...
        registerItem(356, "repeater", (new ItemReed(Blocks.unpowered_repeater)).c("diode").setCreativeTab(CreativeTabs.tabRedstone));
        registerItem(357, "cookie", (new ItemFood(2, 0.1F, false)).c("cookie"));
        registerItem(358, "filled_map", (new ItemMap()).c("map"));
        ...
        registerItem(365, "chicken", (new ItemFood(2, 0.3F, true)).setPotionEffect(Potion.hunger.id, 30, 0, 0.3F).c("chickenRaw"));
        registerItem(366, "cooked_chicken", (new ItemFood(6, 0.6F, true)).c("chickenCooked"));
        registerItem(367, "rotten_flesh", (new ItemFood(4, 0.1F, true)).setPotionEffect(Potion.hunger.id, 30, 0, 0.8F).c("rottenFlesh"));
        ...
        registerItem(372, "nether_wart", (new ItemSeeds(Blocks.nether_wart, Blocks.soul_sand)).c("netherStalkSeeds").setPotionEffect("+4"));
        registerItem(373, "potion", (new ItemPotion()).c("potion"));
        registerItem(374, "glass_bottle", (new ItemGlassBottle()).c("glassBottle"));
        registerItem(375, "spider_eye", (new ItemFood(2, 0.8F, false)).setPotionEffect(Potion.poison.id, 5, 0, 1.0F).c("spiderEye").setPotionEffect("-0-1+2-3&4-4+13"));
        ...
        registerItem(379, "brewing_stand", (new ItemReed(Blocks.brewing_stand)).c("brewingStand").setCreativeTab(CreativeTabs.tabBrewing));
        registerItem(380, "cauldron", (new ItemReed(Blocks.cauldron)).c("cauldron").setCreativeTab(CreativeTabs.tabBrewing));
        ...
        registerItem(383, "spawn_egg", (new ItemMonsterPlacer()).c("monsterPlacer"));
        registerItem(384, "experience_bottle", (new ItemExpBottle()).c("expBottle"));
        registerItem(385, "fire_charge", (new ItemFireball()).c("fireball"));
        registerItem(386, "writable_book", (new ItemWritableBook()).c("writingBook").setCreativeTab(CreativeTabs.tabMisc));
        registerItem(387, "written_book", (new ItemEditableBook()).c("writtenBook").setMaxStackSize(16));
        registerItem(388, "emerald", (new Item()).setUnlocalizedName("emerald").setCreativeTab(CreativeTabs.tabMaterials));
        registerItem(389, "item_frame", (new ItemHangingEntity(EntityItemFrame.class)).c("frame"));
        registerItem(390, "flower_pot", (new ItemReed(Blocks.flower_pot)).c("flowerPot").setCreativeTab(CreativeTabs.tabDecorations));
        ...
        registerItem(394, "poisonous_potato", (new ItemFood(2, 0.3F, false)).setPotionEffect(Potion.poison.id, 5, 0, 0.6F).c("potatoPoisonous"));
        registerItem(395, "map", (new ItemEmptyMap()).c("emptyMap"));
        registerItem(396, "golden_carrot", (new ItemFood(6, 1.2F, false)).c("carrotGolden").setPotionEffect("-0+1+2-3+13&4-4").setCreativeTab(CreativeTabs.tabBrewing));
        registerItem(397, "skull", (new ItemSkull()).c("skull"));
        registerItem(398, "carrot_on_a_stick", (new ItemCarrotOnAStick()).c("carrotOnAStick"));
        registerItem(399, "nether_star", (new ItemSimpleFoiled()).c("netherStar").setCreativeTab(CreativeTabs.tabMaterials));
        registerItem(400, "pumpkin_pie", (new ItemFood(8, 0.3F, false)).c("pumpkinPie").setCreativeTab(CreativeTabs.tabFood));
        registerItem(401, "fireworks", (new ItemFirework()).c("fireworks"));
        registerItem(402, "firework_charge", (new ItemFireworkCharge()).c("fireworksCharge").setCreativeTab(CreativeTabs.tabMisc));
        registerItem(403, "enchanted_book", (new ItemEnchantedBook()).c(1).setUnlocalizedName("enchantedBook"));
        registerItem(404, "comparator", (new ItemReed(Blocks.unpowered_comparator)).c("comparator").setCreativeTab(CreativeTabs.tabRedstone));
        ...
        registerItem(407, "tnt_minecart", (new ItemMinecart(EnumMinecartType.TNT)).c("minecartTnt"));
        registerItem(408, "hopper_minecart", (new ItemMinecart(EnumMinecartType.HOPPER)).c("minecartHopper"));
        ...
        registerItem(416, "armor_stand", (new ItemArmorStand()).c("armorStand").setMaxStackSize(16));
        ...
        registerItem(420, "lead", (new ItemLead()).c("leash"));
        registerItem(421, "name_tag", (new ItemNameTag()).c("nameTag"));
        registerItem(422, "command_block_minecart", (new ItemMinecart(EnumMinecartType.COMMAND_BLOCK)).c("minecartCommandBlock").setCreativeTab((CreativeTabs)null));
    ...
    {
        registerItem(Block.getIdFromBlock(blockIn), (ResourceLocation)Block.blockRegistry.c(blockIn), itemIn);

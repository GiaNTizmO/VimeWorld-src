...
public final class ItemStack
{
    ...
    {
        return this.getItem().hasEffect(this) || this.stackTagCompound != null && this.stackTagCompound.hasKey("Glow");
    }

    public EnumRarity getRarity()
    {
        EnumRarity enumrarity = this.getItem().getRarity(this);

        if (enumrarity == EnumRarity.COMMON && this.stackTagCompound != null && this.stackTagCompound.hasKey("Glow"))
        {
    ...
    public IChatComponent getChatComponent()
    {
        ...
        if (this.item != null)
        {
            ...
            ichatcomponent.getChatStyle().setChatHoverEvent(new HoverEvent(Action.SHOW_ITEM, new ChatComponentText(nbttagcompound.toString())));

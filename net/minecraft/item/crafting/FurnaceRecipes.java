...
public class FurnaceRecipes
{
    ...
    private FurnaceRecipes()
    {
        ...
        this.addSmeltingRecipeForBlock(Blocks.log_stripped1, new ItemStack(Items.coal, 1, 1), 0.15F);
        this.addSmeltingRecipeForBlock(Blocks.log_stripped2, new ItemStack(Items.coal, 1, 1), 0.15F);
    }

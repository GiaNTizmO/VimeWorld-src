...
public class BlockNewLog extends BlockLog
{
    ...
    public void getSubBlocks(Item itemIn, CreativeTabs tab, List<ItemStack> list)
    {
        ...
        list.add(new ItemStack(itemIn, 1, BlockPlanks.EnumType.CRIMSON.getMetadata() - 4));
        list.add(new ItemStack(itemIn, 1, BlockPlanks.EnumType.WARPED.getMetadata() - 4));
    }
    ...
    {
        IBlockState iblockstate = this.Q().withProperty(VARIANT, BlockPlanks.EnumType.byMetadata((meta & 3) + 4));

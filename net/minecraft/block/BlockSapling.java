...
{
    public static final PropertyEnum<BlockPlanks.EnumType> TYPE = PropertyEnum.create("type", BlockPlanks.EnumType.class, new Predicate<BlockPlanks.EnumType>()
    {
        public boolean apply(BlockPlanks.EnumType p_apply_1_)
        {
            return p_apply_1_.getMetadata() <= 5;
        }
    });
    ...
    {
        this.j(this.M.getBaseState().withProperty(TYPE, BlockPlanks.EnumType.OAK).withProperty(STAGE, Integer.valueOf(0)));
        float f = 0.4F;
    ...
    {
        return StatCollector.translateToLocal(this.a() + "." + BlockPlanks.EnumType.OAK.getUnlocalizedName() + ".name");
    }
    ...
    public void generateTree(World worldIn, BlockPos pos, IBlockState state, Random rand)
    {
        ...
        switch ((BlockPlanks.EnumType)state.getValue(TYPE))
        {
            ...
            case JUNGLE:
                ...
                IBlockState iblockstate1 = Blocks.leaves.Q().withProperty(BlockOldLeaf.VARIANT, BlockPlanks.EnumType.JUNGLE).withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
                label269:
    ...
    public void getSubBlocks(Item itemIn, CreativeTabs tab, List<ItemStack> list)
    {
        ...
        {
            if (blockplanks$enumtype.getMetadata() > 5)
            {
                return;
            }
    ...
    {
        return this.Q().withProperty(TYPE, BlockPlanks.EnumType.byMetadata(meta & 7)).withProperty(STAGE, Integer.valueOf((meta & 8) >> 3));
    }

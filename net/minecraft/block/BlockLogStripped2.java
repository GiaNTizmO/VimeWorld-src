...
public class BlockLogStripped2 extends BlockLog
{
    ...
    {
        this.j(this.M.getBaseState().withProperty(VARIANT, BlockPlanks.EnumType.ACACIA).withProperty(LOG_AXIS, EnumAxis.Y));
    }
    ...
    {
        p_a_3_.add(new ItemStack(p_a_1_, 1, BlockPlanks.EnumType.ACACIA.getMetadata() - 4));
        p_a_3_.add(new ItemStack(p_a_1_, 1, BlockPlanks.EnumType.DARK_OAK.getMetadata() - 4));
        p_a_3_.add(new ItemStack(p_a_1_, 1, BlockPlanks.EnumType.CRIMSON.getMetadata() - 4));
        p_a_3_.add(new ItemStack(p_a_1_, 1, BlockPlanks.EnumType.WARPED.getMetadata() - 4));
    }
    ...
    {
        int i = 0;
        i = i | ((BlockPlanks.EnumType)p_c_1_.getValue(VARIANT)).getMetadata() - 4;
    ...
    {
        return new ItemStack(Item.getItemFromBlock(this), 1, ((BlockPlanks.EnumType)p_i_1_.getValue(VARIANT)).getMetadata() - 4);
    }

    public int a(IBlockState p_a_1_)
    {
        return ((BlockPlanks.EnumType)p_a_1_.getValue(VARIANT)).getMetadata() - 4;
    }
}

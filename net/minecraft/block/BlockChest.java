...
public class BlockChest extends BlockContainer
{
    ...
    {
        super(Material.wood);
        this.j(this.M.getBaseState().withProperty(FACING, EnumFacing.NORTH));
        this.chestType = type;
    ...
    {
        return this.Q().withProperty(FACING, placer.getHorizontalFacing());
    }
    ...
    {
        super.a(worldIn, pos, state, neighborBlock);
        TileEntity tileentity = worldIn.getTileEntity(pos);
    ...
    {
        for (Entity entity : worldIn.getEntitiesWithinAABB(EntityOcelot.class, new AxisAlignedBB((double)pos.n(), (double)(pos.o() + 1), (double)pos.p(), (double)(pos.n() + 1), (double)(pos.o() + 2), (double)(pos.p() + 1))))
        {
    ...
    public IBlockState getStateFromMeta(int meta)
    {
        ...
        return this.Q().withProperty(FACING, enumfacing);
    }

...
public class BlockFire extends Block
{
    ...
    public static void init()
    {
        ...
        Blocks.fire.setFireInfo(Blocks.crimson_stairs, 5, 20);
        Blocks.fire.setFireInfo(Blocks.warped_stairs, 5, 20);
        Blocks.fire.setFireInfo(Blocks.log_stripped1, 5, 5);
        Blocks.fire.setFireInfo(Blocks.log_stripped2, 5, 5);
    }
    ...
    public void randomDisplayTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
    {
        ...
        {
            worldIn.playSound((double)((float)pos.n() + 0.5F), (double)((float)pos.o() + 0.5F), (double)((float)pos.p() + 0.5F), "fire.fire", 1.0F + rand.nextFloat(), rand.nextFloat() * 0.7F + 0.3F, false);
        }
        ...
        if (!World.doesBlockHaveSolidTopSurface(worldIn, pos.down()) && !Blocks.fire.canCatchFire(worldIn, pos.down()))
        {
            if (Blocks.fire.canCatchFire(worldIn, pos.west()))
            {
                for (int j = 0; j < 2; ++j)
                {
                    double d3 = (double)pos.n() + rand.nextDouble() * 0.10000000149011612D;
                    double d8 = (double)pos.o() + rand.nextDouble();
                    double d13 = (double)pos.p() + rand.nextDouble();
            ...
            if (Blocks.fire.canCatchFire(worldIn, pos.east()))
            {
                for (int k = 0; k < 2; ++k)
                {
                    double d4 = (double)(pos.n() + 1) - rand.nextDouble() * 0.10000000149011612D;
                    double d9 = (double)pos.o() + rand.nextDouble();
                    double d14 = (double)pos.p() + rand.nextDouble();
            ...
            if (Blocks.fire.canCatchFire(worldIn, pos.north()))
            {
                for (int l = 0; l < 2; ++l)
                {
                    double d5 = (double)pos.n() + rand.nextDouble();
                    double d10 = (double)pos.o() + rand.nextDouble();
                    double d15 = (double)pos.p() + rand.nextDouble() * 0.10000000149011612D;
            ...
            if (Blocks.fire.canCatchFire(worldIn, pos.south()))
            {
                ...
                {
                    double d6 = (double)pos.n() + rand.nextDouble();
                    double d11 = (double)pos.o() + rand.nextDouble();
                    double d16 = (double)(pos.p() + 1) - rand.nextDouble() * 0.10000000149011612D;
            ...
            if (Blocks.fire.canCatchFire(worldIn, pos.up()))
            {
                ...
                {
                    double d7 = (double)pos.n() + rand.nextDouble();
                    double d12 = (double)(pos.o() + 1) - rand.nextDouble() * 0.10000000149011612D;
                    double d17 = (double)pos.p() + rand.nextDouble();
        ...
        else
        {
            for (int i = 0; i < 3; ++i)
            {
                double d0 = (double)pos.n() + rand.nextDouble();
                double d1 = (double)pos.o() + rand.nextDouble() * 0.5D + 0.5D;
                double d2 = (double)pos.p() + rand.nextDouble();

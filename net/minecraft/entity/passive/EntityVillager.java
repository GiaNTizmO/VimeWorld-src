...
public class EntityVillager extends EntityAgeable implements IMerchant, INpc
{
    ...
    public EntityVillager(World worldIn, int professionId)
    {
        ...
        this.setSize(getDefaultWidth(), 1.8F);
        ...
        this.i.addTask(1, new EntityAIAvoidEntity(this, EntityZombie.class, 8.0F, 0.6D, 0.6D));
        ...
        this.i.addTask(5, new EntityAIMoveTowardsRestriction(this, 0.6D));
        ...
        this.i.addTask(9, new EntityAIWander(this, 0.6D));
    ...
    private void setAdditionalAItasks()
    {
        if (!this.areAdditionalTasksSet)
        {
            ...
            if (this.isChild())
            {
                this.i.addTask(8, new EntityAIPlay(this, 0.32D));
            }
            else if (this.getProfession() == 0)
            {
                this.i.addTask(6, new EntityAIHarvestFarmland(this, 0.6D));
            }
        }
    }
    ...
    protected void onGrowingAdult()
    {
        ...
        {
            this.i.addTask(8, new EntityAIHarvestFarmland(this, 0.6D));
        }
    ...
    {
        super.aX();
        this.a(SharedMonsterAttributes.movementSpeed).setBaseValue(0.5D);
    }
    ...
    protected void updateAITasks()
    {
        if (--this.randomTickDivider <= 0)
        {
            ...
            this.o.getVillageCollection().addToVillagerPositionList(blockpos);
            this.randomTickDivider = 70 + this.V.nextInt(50);
            this.villageObj = this.o.getVillageCollection().getNearestVillage(blockpos, 32);
            ...
            else
            {
                ...
                this.a(blockpos1, (int)((float)this.villageObj.getVillageRadius() * 1.0F));
            ...
            if (this.timeUntilReset <= 0)
            {
                if (this.needsInitilization)
                {
                    for (MerchantRecipe merchantrecipe : this.buyingList)
                    {
                        ...
                        {
                            merchantrecipe.increaseMaxTradeUses(this.V.nextInt(6) + this.V.nextInt(6) + 2);
                        }
                    }
    ...
    public boolean interact(EntityPlayer player)
    {
        ...
        if (!flag && this.ai() && !this.isTrading() && !this.isChild())
        {
            if (!this.o.isRemote && (this.buyingList == null || this.buyingList.size() > 0))
            {
    ...
    {
        super.entityInit();
        this.ac.addObject(16, Integer.valueOf(0));
    }
    ...
    {
        this.ac.updateObject(16, Integer.valueOf(professionId));
    }
    ...
    public void onDeath(DamageSource cause)
    {
        if (this.villageObj != null)
        {
            ...
            {
                EntityPlayer entityplayer = this.o.getClosestPlayerToEntity(this, 16.0D);
    ...
    public void useRecipe(MerchantRecipe recipe)
    {
        ...
        int i = 3 + this.V.nextInt(4);

        if (recipe.getToolUses() == 1 || this.V.nextInt(5) == 0)
        {
        ...
        {
            this.o.spawnEntityInWorld(new EntityXPOrb(this.o, this.s, this.t + 0.5D, this.u, i));
        }
    }
    ...
    {
        if (!this.o.isRemote && this.a_ > -this.w() + 20)
        {
            this.a_ = -this.w();
    ...
    private void populateBuyingList()
    {
        ...
        {
            this.careerId = this.V.nextInt(aentityvillager$itradelist.length) + 1;
            this.careerLevel = 1;
        }
        ...
        if (j >= 0 && j < aentityvillager$itradelist1.length)
        {
            ...
            {
                entityvillager$itradelist.modifyMerchantRecipeList(this.buyingList, this.V);
            }
        }
    }
    ...
    public IChatComponent getDisplayName()
    {
        ...
        if (s != null && s.length() > 0)
        {
            ...
            chatcomponenttext.getChatStyle().setChatHoverEvent(this.aQ());
            chatcomponenttext.getChatStyle().setInsertion(this.aK().toString());
        ...
        else
        {
            ...
            if (s1 != null)
            {
                ...
                chatcomponenttranslation.b().setChatHoverEvent(this.aQ());
                chatcomponenttranslation.b().setInsertion(this.aK().toString());
    ...
    private void spawnParticles(EnumParticleTypes particleType)
    {
        for (int i = 0; i < 5; ++i)
        {
            ...
            this.o.spawnParticle(particleType, this.s + (double)(this.V.nextFloat() * this.J * 2.0F) - (double)this.J, this.t + 1.0D + (double)(this.V.nextFloat() * this.K), this.u + (double)(this.V.nextFloat() * this.J * 2.0F) - (double)this.J, d0, d1, d2, new int[0]);
        }
    }
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, IEntityLivingData livingdata)
    {
        ...
        this.setProfession(this.o.rand.nextInt(5));
        this.setAdditionalAItasks();
        return livingdata;
    }
    ...
    {
        if (!this.o.isRemote && !this.I)
        {
            EntityWitch entitywitch = new EntityWitch(this.o);
            entitywitch.b(this.s, this.t, this.u, this.y, this.z);
            entitywitch.a(this.o.getDifficultyForLocation(new BlockPos(entitywitch)), (IEntityLivingData)null);
            entitywitch.k(this.ce());

            if (this.l_())
            {
                entitywitch.a(this.aM());
                entitywitch.g(this.aN());
            }

            this.o.spawnEntityInWorld(entitywitch);
            this.J();
        }
    }
    ...
    {
        if (super.d(inventorySlot, itemStackIn))
        {
            return true;
        }
        else

...
{
    private static final ObfValue.ODouble OBFVAL_21 = ObfValue.create(0.5D);
    private static final ObfValue.OInteger OBFVAL_20 = ObfValue.create(3);
    private static final ObfValue.OInteger OBFVAL_19 = ObfValue.create(9);
    private static final ObfValue.OInteger OBFVAL_18 = ObfValue.create(100);
    private static final ObfValue.ODouble OBFVAL_17 = ObfValue.create(0.20000000298023224D);
    private static final ObfValue.OFloat OBFVAL_16 = ObfValue.create(-1.0F);
    private static final ObfValue.OInteger OBFVAL_15 = ObfValue.create(20);
    private static final ObfValue.OInteger OBFVAL_14 = ObfValue.create(65535);
    private static final ObfValue.OInteger OBFVAL_13 = ObfValue.create(256);
    private static final ObfValue.OInteger OBFVAL_12 = ObfValue.create(16);
    private static final ObfValue.OInteger OBFVAL_11 = ObfValue.create(4);
    private static final ObfValue.OInteger OBFVAL_10 = ObfValue.create(10);
    private static final ObfValue.OInteger OBFVAL_9 = ObfValue.create(Integer.MAX_VALUE);
    private static final ObfValue.OInteger OBFVAL_8 = ObfValue.create(99);
    private static final ObfValue.ODouble OBFVAL_7 = ObfValue.create(255.0D);
    private static final ObfValue.OInteger OBFVAL_6 = ObfValue.create(2);
    ...
    private static final ObfValue.OInteger OBFVAL_3 = ObfValue.create(60);
    private static final ObfValue.OInteger OBFVAL_2 = ObfValue.create(-99999999);
    private static final ObfValue.OFloat OBFVAL_1 = ObfValue.create(-1.0E8F);
    private static final ObfValue.OFloat OBFVAL_0 = ObfValue.create(Float.MIN_VALUE);
    ...
    public EntityPlayerMP(MinecraftServer server, WorldServer worldIn, GameProfile profile, ItemInWorldManager interactionManager)
    {
        ...
        this.combinedHealth = OBFVAL_0.get();
        this.lastHealth = OBFVAL_1.get();
        this.lastFoodLevel = OBFVAL_2.get();
        this.wasHungry = true;
        this.lastExperience = OBFVAL_2.get();
        this.respawnInvulnerabilityTicks = OBFVAL_3.get();
        ...
        BlockPos blockpos = worldIn.M();

        if (!worldIn.t.getHasNoSky() && worldIn.P().getGameType() != GameType.ADVENTURE)
        {
            int i = Math.max(OBFVAL_4.get(), server.getSpawnProtectionSize() - OBFVAL_5.get());
            int j = MathHelper.floor_double(worldIn.af().getClosestDistance((double)blockpos.n(), (double)blockpos.p()));
            ...
            blockpos = worldIn.r(blockpos.add(this.rand.nextInt(i * OBFVAL_6.get()) - i, 0, this.rand.nextInt(i * OBFVAL_6.get()) - i));
        }
        ...
        while (!worldIn.a(this, this.getEntityBoundingBox()).isEmpty() && this.posY < OBFVAL_7.get())
        {
    ...
    public void readEntityFromNBT(NBTTagCompound tagCompund)
    {
        ...
        if (tagCompund.hasKey("playerGameType", OBFVAL_8.get()))
        {
    ...
    public void onUpdate()
    {
        ...
        {
            int i = Math.min(this.destroyedItemsNetCache.size(), OBFVAL_9.get());
            int[] aint = new int[i];
        ...
        if (!this.loadedChunks.isEmpty())
        {
            ...
            while (iterator1.hasNext() && ((List)list).size() < OBFVAL_10.get())
            {
                ChunkCoordIntPair chunkcoordintpair = (ChunkCoordIntPair)iterator1.next();

                if (chunkcoordintpair != null)
                {
                    if (this.worldObj.isBlockLoaded(new BlockPos(chunkcoordintpair.chunkXPos << OBFVAL_11.get(), 0, chunkcoordintpair.chunkZPos << OBFVAL_11.get())))
                    {
                        ...
                        {
                            list.add(chunk);
                            list1.addAll(((WorldServer)this.worldObj).getTileEntitiesIn(chunkcoordintpair.chunkXPos * OBFVAL_12.get(), 0, chunkcoordintpair.chunkZPos * OBFVAL_12.get(), chunkcoordintpair.chunkXPos * OBFVAL_12.get() + OBFVAL_12.get(), OBFVAL_13.get(), chunkcoordintpair.chunkZPos * OBFVAL_12.get() + OBFVAL_12.get()));
                            iterator1.remove();
                        }
                    }
                }
            ...
            if (!list.isEmpty())
            {
                if (list.size() == 1)
                {
                    this.playerNetServerHandler.sendPacket(new S21PacketChunkData((Chunk)list.get(0), true, OBFVAL_14.get()));
                }
                else
                {
    ...
    public void onUpdateEntity()
    {
        try
        {
            ...
            if (this.ticksExisted % OBFVAL_15.get() * OBFVAL_4.get() == 0 && !this.getStatFile().a(AchievementList.exploreAllBiomes))
            {
    ...
    protected void updateBiomesExplored()
    {
        ...
        JsonSerializableSet jsonserializableset = (JsonSerializableSet)this.getStatFile().b(AchievementList.exploreAllBiomes);

        if (jsonserializableset == null)
        {
            jsonserializableset = (JsonSerializableSet)this.getStatFile().a(AchievementList.exploreAllBiomes, new JsonSerializableSet());
        }

        jsonserializableset.add(s);

        if (this.getStatFile().b(AchievementList.exploreAllBiomes) && jsonserializableset.size() >= BiomeGenBase.explorationBiomesList.size())
        {
    ...
    public void onDeath(DamageSource cause)
    {
        ...
        {
            EntityEggInfo entityegginfo = (EntityEggInfo)EntityList.entityEggs.get(Integer.valueOf(EntityList.getEntityID(entitylivingbase)));
    ...
    public void travelToDimension(int dimensionId)
    {
        if (this.dimension == 1 && dimensionId == 1)
        {
            ...
            this.playerNetServerHandler.sendPacket(new S2BPacketChangeGameState(OBFVAL_11.get(), 0.0F));
        }
        else
        {
            if (this.dimension == 0 && dimensionId == 1)
            {
                ...
                if (blockpos != null)
                {
                    this.playerNetServerHandler.setPlayerLocation((double)blockpos.n(), (double)blockpos.o(), (double)blockpos.p(), 0.0F, 0.0F);
                }
    ...
    public void wakeUpPlayer(boolean p_70999_1_, boolean updateWorldFlag, boolean setSpawn)
    {
        ...
        {
            this.getServerForPlayer().getEntityTracker().func_151248_b(this, new S0BPacketAnimation(this, OBFVAL_6.get()));
        }
    ...
    public void handleFalling(double p_71122_1_, boolean p_71122_3_)
    {
        ...
        int j = MathHelper.floor_double(this.posY - OBFVAL_17.get());
    ...
    public void openEditSign(TileEntitySign signTile)
    {
        ...
        this.playerNetServerHandler.sendPacket(new S36PacketSignEditorOpen(signTile.v()));
    }
    ...
    {
        this.currentWindowId = this.currentWindowId % OBFVAL_18.get() + 1;
    }

    public void displayGui(IInteractionObject guiOwner)
    {
        this.getNextWindowId();
        this.playerNetServerHandler.sendPacket(new S2DPacketOpenWindow(this.currentWindowId, guiOwner.getGuiID(), guiOwner.f_()));
    ...
    public void displayGUIChest(IInventory chestInventory)
    {
        ...
        if (chestInventory instanceof ILockableContainer)
        {
            ...
            {
                this.playerNetServerHandler.sendPacket(new S02PacketChat(new ChatComponentTranslation("container.isLocked", new Object[] {chestInventory.f_()}), (byte)OBFVAL_6.get()));
        ...
        {
            this.playerNetServerHandler.sendPacket(new S2DPacketOpenWindow(this.currentWindowId, ((IInteractionObject)chestInventory).getGuiID(), chestInventory.f_(), chestInventory.getSizeInventory()));
            this.openContainer = ((IInteractionObject)chestInventory).createContainer(this.inventory, this);
        }
        else
        {
            this.playerNetServerHandler.sendPacket(new S2DPacketOpenWindow(this.currentWindowId, "minecraft:container", chestInventory.f_(), chestInventory.getSizeInventory()));
    ...
    public void displayGUIHorse(EntityHorse horse, IInventory horseInventory)
    {
        ...
        this.getNextWindowId();
        this.playerNetServerHandler.sendPacket(new S2DPacketOpenWindow(this.currentWindowId, "EntityHorse", horseInventory.f_(), horseInventory.getSizeInventory(), horse.F()));
    ...
    public void setEntityActionState(float p_110430_1_, float p_110430_2_, boolean p_110430_3_, boolean sneaking)
    {
        ...
        {
            if (p_110430_1_ >= OBFVAL_16.get() && p_110430_1_ <= 1.0F)
            {
                this.moveStrafing = p_110430_1_;
            }

            if (p_110430_2_ >= OBFVAL_16.get() && p_110430_2_ <= 1.0F)
            {
    ...
    public void addStat(StatBase stat, int amount)
    {
        if (stat != null)
        {
            this.statsFile.b(this, stat, amount);
    ...
    {
        this.playerNetServerHandler.sendPacket(new S19PacketEntityStatus(this, (byte)OBFVAL_19.get()));
    ...
    public void setItemInUse(ItemStack stack, int duration)
    {
        ...
        {
            this.getServerForPlayer().getEntityTracker().func_151248_b(this, new S0BPacketAnimation(this, OBFVAL_20.get()));
        }
    }
    ...
    {
        this.getServerForPlayer().getEntityTracker().func_151248_b(this, new S0BPacketAnimation(entityHit, OBFVAL_11.get()));
    }

    public void onEnchantmentCritical(Entity entityHit)
    {
        this.getServerForPlayer().getEntityTracker().func_151248_b(this, new S0BPacketAnimation(entityHit, OBFVAL_4.get()));
    }
    ...
    public void setGameType(GameType gameType)
    {
        ...
        this.playerNetServerHandler.sendPacket(new S2BPacketChangeGameState(OBFVAL_20.get(), (float)gameType.getID()));
    ...
    public boolean canCommandSenderUseCommand(int permLevel, String commandName)
    {
        ...
        else if (!"tell".equals(commandName) && !"help".equals(commandName) && !"me".equals(commandName) && !"trigger".equals(commandName))
        {
            ...
            {
                UserListOpsEntry userlistopsentry = (UserListOpsEntry)this.mcServer.getConfigurationManager().getOppedPlayers().b(this.getGameProfile());
    ...
    public void handleClientSettings(C15PacketClientSettings packetIn)
    {
        ...
        this.getDataWatcher().updateObject(OBFVAL_10.get(), Byte.valueOf((byte)packetIn.getModelPartFlags()));
    }
    ...
    {
        return new BlockPos(this.posX, this.posY + OBFVAL_21.get(), this.posZ);
    }
    ...
    static
    {
        ...
        ObfValue.endGeneration(new byte[] {(byte)33, (byte) - 75, (byte) - 8, (byte)40, (byte)74, (byte)30, (byte)23, (byte) - 17});
    }
}

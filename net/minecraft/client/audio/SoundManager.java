            ...
            try
            {
                (new Thread(new Runnable()
                {
                    public void run()
                    {
                        ...
                        try
                        {
                            Charset charset1 = Charset.forName(System.getProperty("file.encoding.system"));
                            Reflect.set((Class)Charset.class, "defaultCharset", charset1);
                        }
                        ...
                        SoundManager soundmanager1 = SoundManager.this;
                        SoundManager.this.getClass();
                        soundmanager.sndSystem = soundmanager1.new SoundSystemStarterThread();
    ...
    public void updateAllSounds()
    {
        ...
        for (ITickableSound itickablesound : this.tickableSounds)
        {
            ...
            else
            {
                ...
                this.sndSystem.setVolume(s, this.getNormalizedVolume(itickablesound, (SoundPoolEntry)this.playingSoundPoolEntries.get(itickablesound), this.sndHandler.getSound(itickablesound.a()).getSoundCategory()));
                ...
                this.sndSystem.setPosition(s, itickablesound.g(), itickablesound.h(), itickablesound.i());
            }
        }

...
public class SoundHandler implements IResourceManagerReloadListener, ITickable
{
    ...
    private static final ParameterizedType TYPE = new 1();
    ...
    public final SoundRegistry sndRegistry = new SoundRegistry();
    ...
    {
        boolean flag = !this.sndRegistry.d(location);
        SoundEventAccessorComposite soundeventaccessorcomposite;

        if (!flag && !sounds.canReplaceExisting())
        {
            soundeventaccessorcomposite = (SoundEventAccessorComposite)this.sndRegistry.a(location);
        }
        else
        {
            if (!flag)
        ...
        for (final SoundEntry soundentry : sounds.getSoundList())
        {
            ...
            switch (3.$SwitchMap$net$minecraft$client$audio$SoundList$SoundEntry$Type[soundentry.getSoundEntryType().ordinal()])
            {
                case 1:
                    ...
                    object = new SoundEventAccessor(new SoundPoolEntry(resourcelocation1, (double)soundentry.getSoundEntryPitch(), (double)soundentry.getSoundEntryVolume(), soundentry.isStreaming()), soundentry.getSoundEntryWeight());
                    break;
                ...
                case 2:
                    object = new ISoundEventAccessor<SoundPoolEntry>()
                    {
                        ...
                        {
                            SoundEventAccessorComposite soundeventaccessorcomposite1 = (SoundEventAccessorComposite)SoundHandler.this.sndRegistry.a(this.field_148726_a);
    ...
    {
        return (SoundEventAccessorComposite)this.sndRegistry.a(location);
    }
    ...
    public SoundEventAccessorComposite getRandomSoundFromCategories(SoundCategory... categories)
    {
        ...
        for (ResourceLocation resourcelocation : this.sndRegistry.c())
        {
            SoundEventAccessorComposite soundeventaccessorcomposite = (SoundEventAccessorComposite)this.sndRegistry.a(resourcelocation);

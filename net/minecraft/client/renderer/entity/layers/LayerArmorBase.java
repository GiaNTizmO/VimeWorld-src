...
public abstract class LayerArmorBase<T extends ModelBase> implements LayerRenderer<EntityLivingBase>
{
    ...
    private void renderLayer(EntityLivingBase entitylivingbaseIn, float p_177182_2_, float p_177182_3_, float p_177182_4_, float p_177182_5_, float p_177182_6_, float p_177182_7_, float p_177182_8_, int armorSlot)
    {
        ...
        if (itemstack != null && itemstack.getItem() instanceof ItemArmor)
        {
            ...
            switch (LayerArmorBase.LayerArmorBase$LayerArmorBase$1.field_178747_a[itemarmor.getArmorMaterial().ordinal()])
            {
                case 1:
    ...
    static final class LayerArmorBase$LayerArmorBase$1
    {
        static final int[] field_178747_a = new int[ArmorMaterial.values().length];

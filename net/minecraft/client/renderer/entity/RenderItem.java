...
public class RenderItem implements IResourceManagerReloadListener
{
    ...
    private void registerItems()
    {
        ...
        this.registerBlock(Blocks.log2, BlockPlanks.EnumType.CRIMSON.getMetadata() - 4, "crimson_log");
        this.registerBlock(Blocks.log2, BlockPlanks.EnumType.WARPED.getMetadata() - 4, "warped_log");
        this.registerBlock(Blocks.monster_egg, EnumType.CHISELED_STONEBRICK.getMetadata(), "chiseled_brick_monster_egg");
        this.registerBlock(Blocks.monster_egg, EnumType.COBBLESTONE.getMetadata(), "cobblestone_monster_egg");
        this.registerBlock(Blocks.monster_egg, EnumType.CRACKED_STONEBRICK.getMetadata(), "cracked_brick_monster_egg");
        this.registerBlock(Blocks.monster_egg, EnumType.MOSSY_STONEBRICK.getMetadata(), "mossy_brick_monster_egg");
        this.registerBlock(Blocks.monster_egg, EnumType.STONE.getMetadata(), "stone_monster_egg");
        this.registerBlock(Blocks.monster_egg, EnumType.STONEBRICK.getMetadata(), "stone_brick_monster_egg");
        ...
        this.registerBlock(Blocks.planks, BlockPlanks.EnumType.CRIMSON.getMetadata(), "crimson_planks");
        this.registerBlock(Blocks.planks, BlockPlanks.EnumType.WARPED.getMetadata(), "warped_planks");
        ...
        this.registerBlock(Blocks.wooden_slab, BlockPlanks.EnumType.CRIMSON.getMetadata(), "crimson_slab");
        this.registerBlock(Blocks.wooden_slab, BlockPlanks.EnumType.WARPED.getMetadata(), "warped_slab");
        ...
        this.registerBlock(Blocks.crimson_stairs, "crimson_stairs");
        this.registerBlock(Blocks.warped_stairs, "warped_stairs");
        this.registerBlock(Blocks.log_stripped1, BlockPlanks.EnumType.BIRCH.getMetadata(), "birch_log_stripped");
        this.registerBlock(Blocks.log_stripped1, BlockPlanks.EnumType.JUNGLE.getMetadata(), "jungle_log_stripped");
        this.registerBlock(Blocks.log_stripped1, BlockPlanks.EnumType.OAK.getMetadata(), "oak_log_stripped");
        this.registerBlock(Blocks.log_stripped1, BlockPlanks.EnumType.SPRUCE.getMetadata(), "spruce_log_stripped");
        this.registerBlock(Blocks.log_stripped2, BlockPlanks.EnumType.ACACIA.getMetadata() - 4, "acacia_log_stripped");
        this.registerBlock(Blocks.log_stripped2, BlockPlanks.EnumType.DARK_OAK.getMetadata() - 4, "dark_oak_log_stripped");
        this.registerBlock(Blocks.log_stripped2, BlockPlanks.EnumType.CRIMSON.getMetadata() - 4, "crimson_log_stripped");
        this.registerBlock(Blocks.log_stripped2, BlockPlanks.EnumType.WARPED.getMetadata() - 4, "warped_log_stripped");
        this.registerBlock(Blocks.lucky_block, "lucky_block");

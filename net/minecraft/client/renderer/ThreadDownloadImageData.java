...
public class ThreadDownloadImageData extends SimpleTexture
{
    ...
    private static final Pattern SKIN_URL_PATTERN = Pattern.compile("^https?://(?:textures\\.minecraft\\.net/texture/[a-zA-Z0-9_.-]+|mc\\.vimeworld.ru/launcher/(?:skins|cloaks)/[a-zA-Z0-9\u0410-\u042f\u0430-\u044f_-]+\\.png)$");
    ...
    public ThreadDownloadImageData(VimeSkinStorage.Entry p_i10_1_, String p_i10_2_, ResourceLocation p_i10_3_, IImageBuffer p_i10_4_)
    {
        super(p_i10_3_);
        this.cacheEntry = p_i10_1_;
        this.imageUrl = p_i10_2_;
        this.imageBuffer = p_i10_4_;
    }
    ...
    private void checkTextureUploaded()
    {
        if (!this.textureUploaded && this.bufferedImage != null)
        {
            ...
            TextureUtil.uploadTextureImage(super.b(), this.bufferedImage);
        }
    }

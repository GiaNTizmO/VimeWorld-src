...
public class FaceBakery
{
    ...
    {
        switch (1.field_178400_a[facing.ordinal()])
        {
            case 1:
                if (Config.isShaders())
                {
    ...
    private void fillVertexData(int[] p_fillVertexData_1_, int p_fillVertexData_2_, EnumFacing p_fillVertexData_3_, BlockPartFace p_fillVertexData_4_, float[] p_fillVertexData_5_, TextureAtlasSprite p_fillVertexData_6_, ITransformation p_fillVertexData_7_, BlockPartRotation p_fillVertexData_8_, boolean p_fillVertexData_9_, boolean p_fillVertexData_10_)
    {
        ...
        VertexInformation vertexinformation = EnumFaceDirection.getFacing(p_fillVertexData_3_).func_179025_a(p_fillVertexData_2_);
        Vector3f vector3f = new Vector3f(p_fillVertexData_5_[vertexinformation.field_179184_a], p_fillVertexData_5_[vertexinformation.field_179182_b], p_fillVertexData_5_[vertexinformation.field_179183_c]);
    ...
    private void func_178407_a(Vector3f p_178407_1_, BlockPartRotation partRotation)
    {
        if (partRotation != null)
        {
            ...
            switch (1.field_178399_b[partRotation.axis.ordinal()])
            {
                case 1:
    ...
    private void applyFacing(int[] p_applyFacing_1_, EnumFacing p_applyFacing_2_)
    {
        ...
        int i = p_applyFacing_1_.length / 4;
        ...
        {
            int k1 = i * j1;
            VertexInformation vertexinformation = enumfacedirection.func_179025_a(j1);
            float f8 = afloat[vertexinformation.field_179184_a];

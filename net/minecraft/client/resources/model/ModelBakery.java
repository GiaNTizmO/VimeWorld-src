...
public class ModelBakery
{
    ...
    private final Map<ModelResourceLocation, Variants> variants = Maps.<ModelResourceLocation, Variants>newLinkedHashMap();
    ...
    private void loadVariantItemModels()
    {
        ...
        this.variants.put(MODEL_MISSING, new Variants(MODEL_MISSING.getVariant(), Lists.newArrayList(new Variant[] {new Variant(new ResourceLocation(MODEL_MISSING.a()), ModelRotation.X0_Y0, false, 1)})));
    ...
    private void loadVariantModels()
    {
        ...
        {
            for (Variant variant : ((Variants)this.variants.get(modelresourcelocation)).getVariants())
            {
    ...
    private void registerVariantNames()
    {
        ...
        this.variantNames.put(Item.getItemFromBlock(Blocks.planks), Lists.newArrayList(new String[] {"oak_planks", "spruce_planks", "birch_planks", "jungle_planks", "acacia_planks", "dark_oak_planks", "crimson_planks", "warped_planks"}));
        ...
        this.variantNames.put(Item.getItemFromBlock(Blocks.wooden_slab), Lists.newArrayList(new String[] {"oak_slab", "spruce_slab", "birch_slab", "jungle_slab", "acacia_slab", "dark_oak_slab", "crimson_slab", "warped_slab"}));
        ...
        this.variantNames.put(Item.getItemFromBlock(Blocks.log2), Lists.newArrayList(new String[] {"acacia_log", "dark_oak_log", "crimson_log", "warped_log"}));
        ...
        this.variantNames.put(Item.getItemFromBlock(Blocks.concrete), Lists.newArrayList(new String[] {"black_concrete", "red_concrete", "green_concrete", "brown_concrete", "blue_concrete", "purple_concrete", "cyan_concrete", "silver_concrete", "gray_concrete", "pink_concrete", "lime_concrete", "yellow_concrete", "light_blue_concrete", "magenta_concrete", "orange_concrete", "white_concrete"}));
        this.variantNames.put(Item.getItemFromBlock(Blocks.concrete_powder), Lists.newArrayList(new String[] {"black_concrete_powder", "red_concrete_powder", "green_concrete_powder", "brown_concrete_powder", "blue_concrete_powder", "purple_concrete_powder", "cyan_concrete_powder", "silver_concrete_powder", "gray_concrete_powder", "pink_concrete_powder", "lime_concrete_powder", "yellow_concrete_powder", "light_blue_concrete_powder", "magenta_concrete_powder", "orange_concrete_powder", "white_concrete_powder"}));
        this.variantNames.put(Item.getItemFromBlock(Blocks.log_stripped1), Lists.newArrayList(new String[] {"oak_log_stripped", "spruce_log_stripped", "birch_log_stripped", "jungle_log_stripped"}));
        this.variantNames.put(Item.getItemFromBlock(Blocks.log_stripped2), Lists.newArrayList(new String[] {"acacia_log_stripped", "dark_oak_log_stripped", "crimson_log_stripped", "warped_log_stripped"}));
    }
    ...
    private void bakeBlockModels()
    {
        for (ModelResourceLocation modelresourcelocation : this.variants.keySet())
        {
            ...
            for (Variant variant : ((Variants)this.variants.get(modelresourcelocation)).getVariants())
            {
                ...
                {
                    ++i;
                    weightedbakedmodel$builder.add(this.bakeModel(modelblock, variant.getRotation(), variant.isUvLocked()), variant.getWeight());
                }
                else
                {
    ...
    private Set<ResourceLocation> getVariantsTextureLocations()
    {
        ...
        {
            Variants variants = (Variants)this.variants.get(modelresourcelocation);

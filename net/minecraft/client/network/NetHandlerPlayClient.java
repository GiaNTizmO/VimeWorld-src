...
import net.minecraft.network.play.server.S4APacketEmpty;
...
{
    private static final ObfValue.ODouble OBFVAL_52 = ObfValue.create(Double.MAX_VALUE);
    private static final ObfValue.ODouble OBFVAL_51 = ObfValue.create(2.2250738585072014E-308D);
    private static final ObfValue.OInteger OBFVAL_50 = ObfValue.create(32767);
    private static final ObfValue.OInteger OBFVAL_49 = ObfValue.create(1000);
    private static final ObfValue.OInteger OBFVAL_48 = ObfValue.create(8);
    private static final ObfValue.OInteger OBFVAL_47 = ObfValue.create(7);
    private static final ObfValue.OFloat OBFVAL_46 = ObfValue.create(0.45F);
    private static final ObfValue.OFloat OBFVAL_45 = ObfValue.create(0.18F);
    private static final ObfValue.OFloat OBFVAL_44 = ObfValue.create(103.0F);
    private static final ObfValue.OFloat OBFVAL_43 = ObfValue.create(102.0F);
    private static final ObfValue.OFloat OBFVAL_42 = ObfValue.create(101.0F);
    private static final ObfValue.OInteger OBFVAL_41 = ObfValue.create(6);
    private static final ObfValue.OInteger OBFVAL_40 = ObfValue.create(45);
    private static final ObfValue.OInteger OBFVAL_39 = ObfValue.create(36);
    private static final ObfValue.OInteger OBFVAL_38 = ObfValue.create(21);
    private static final ObfValue.OFloat OBFVAL_37 = ObfValue.create(8000.0F);
    private static final ObfValue.OFloat OBFVAL_36 = ObfValue.create(0.5F);
    private static final ObfValue.OFloat OBFVAL_35 = ObfValue.create(2.0F);
    private static final ObfValue.OFloat OBFVAL_34 = ObfValue.create(0.7F);
    private static final ObfValue.OFloat OBFVAL_33 = ObfValue.create(0.2F);
    private static final ObfValue.OInteger OBFVAL_32 = ObfValue.create(256);
    private static final ObfValue.OInteger OBFVAL_31 = ObfValue.create(15);
    ...
    private static final ObfValue.ODouble OBFVAL_27 = ObfValue.create(0.015625D);
    private static final ObfValue.ODouble OBFVAL_26 = ObfValue.create(0.03125D);
    private static final ObfValue.OFloat OBFVAL_25 = ObfValue.create(256.0F);
    private static final ObfValue.OInteger OBFVAL_24 = ObfValue.create(360);
    private static final ObfValue.OInteger OBFVAL_23 = ObfValue.create(65535);
    private static final ObfValue.OInteger OBFVAL_22 = ObfValue.create(70);
    private static final ObfValue.OInteger OBFVAL_21 = ObfValue.create(2);
    private static final ObfValue.OInteger OBFVAL_20 = ObfValue.create(51);
    private static final ObfValue.OInteger OBFVAL_19 = ObfValue.create(78);
    private static final ObfValue.OInteger OBFVAL_18 = ObfValue.create(50);
    private static final ObfValue.OInteger OBFVAL_17 = ObfValue.create(75);
    private static final ObfValue.OInteger OBFVAL_16 = ObfValue.create(73);
    private static final ObfValue.OInteger OBFVAL_15 = ObfValue.create(62);
    private static final ObfValue.OInteger OBFVAL_14 = ObfValue.create(66);
    private static final ObfValue.OInteger OBFVAL_13 = ObfValue.create(64);
    private static final ObfValue.ODouble OBFVAL_12 = ObfValue.create(8000.0D);
    private static final ObfValue.OInteger OBFVAL_11 = ObfValue.create(63);
    private static final ObfValue.OInteger OBFVAL_10 = ObfValue.create(76);
    private static final ObfValue.OInteger OBFVAL_9 = ObfValue.create(72);
    private static final ObfValue.OInteger OBFVAL_8 = ObfValue.create(65);
    private static final ObfValue.OInteger OBFVAL_7 = ObfValue.create(77);
    private static final ObfValue.OInteger OBFVAL_6 = ObfValue.create(71);
    private static final ObfValue.OInteger OBFVAL_5 = ObfValue.create(61);
    private static final ObfValue.OInteger OBFVAL_4 = ObfValue.create(60);
    private static final ObfValue.OInteger OBFVAL_3 = ObfValue.create(90);
    private static final ObfValue.OInteger OBFVAL_2 = ObfValue.create(10);
    private static final ObfValue.ODouble OBFVAL_1 = ObfValue.create(32.0D);
    private static final ObfValue.OInteger OBFVAL_0 = ObfValue.create(20);
    ...
    {
        this.currentServerMaxPlayers = OBFVAL_0.get();
    ...
    public void handleJoinGame(S01PacketJoinGame packetIn)
    {
        ...
        MiniDot.instance.handleJoinGame();
    }
    ...
    {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        double d0 = (double)packetIn.getX() / OBFVAL_1.get();
        double d1 = (double)packetIn.getY() / OBFVAL_1.get();
        double d2 = (double)packetIn.getZ() / OBFVAL_1.get();
        Entity entity = null;

        if (packetIn.getType() == OBFVAL_2.get())
        {
            entity = EntityMinecart.func_180458_a(this.clientWorldController, d0, d1, d2, EnumMinecartType.byNetworkID(packetIn.func_149009_m()));
        }
        else if (packetIn.getType() == OBFVAL_3.get())
        {
        ...
        else if (packetIn.getType() == OBFVAL_7.get())
        {
        ...
        else if (packetIn.getType() == OBFVAL_8.get())
        {
            entity = new EntityEnderPearl(this.clientWorldController, d0, d1, d2);
        }
        else if (packetIn.getType() == OBFVAL_9.get())
        {
            entity = new EntityEnderEye(this.clientWorldController, d0, d1, d2);
        }
        else if (packetIn.getType() == OBFVAL_10.get())
        {
            entity = new EntityFireworkRocket(this.clientWorldController, d0, d1, d2, (ItemStack)null);
        }
        else if (packetIn.getType() == OBFVAL_11.get())
        {
            entity = new EntityLargeFireball(this.clientWorldController, d0, d1, d2, (double)packetIn.getSpeedX() / OBFVAL_12.get(), (double)packetIn.getSpeedY() / OBFVAL_12.get(), (double)packetIn.getSpeedZ() / OBFVAL_12.get());
            packetIn.func_149002_g(0);
        }
        else if (packetIn.getType() == OBFVAL_13.get())
        {
            entity = new EntitySmallFireball(this.clientWorldController, d0, d1, d2, (double)packetIn.getSpeedX() / OBFVAL_12.get(), (double)packetIn.getSpeedY() / OBFVAL_12.get(), (double)packetIn.getSpeedZ() / OBFVAL_12.get());
            packetIn.func_149002_g(0);
        }
        else if (packetIn.getType() == OBFVAL_14.get())
        {
            entity = new EntityWitherSkull(this.clientWorldController, d0, d1, d2, (double)packetIn.getSpeedX() / OBFVAL_12.get(), (double)packetIn.getSpeedY() / OBFVAL_12.get(), (double)packetIn.getSpeedZ() / OBFVAL_12.get());
            packetIn.func_149002_g(0);
        }
        else if (packetIn.getType() == OBFVAL_15.get())
        {
            entity = new EntityEgg(this.clientWorldController, d0, d1, d2);
        }
        else if (packetIn.getType() == OBFVAL_16.get())
        {
            entity = new EntityPotion(this.clientWorldController, d0, d1, d2, packetIn.func_149009_m());
            packetIn.func_149002_g(0);
        }
        else if (packetIn.getType() == OBFVAL_17.get())
        {
        ...
        else if (packetIn.getType() == OBFVAL_18.get())
        {
            entity = new EntityTNTPrimed(this.clientWorldController, d0, d1, d2, (EntityLivingBase)null);
        }
        else if (packetIn.getType() == OBFVAL_19.get())
        {
            entity = new EntityArmorStand(this.clientWorldController, d0, d1, d2);
        }
        else if (packetIn.getType() == OBFVAL_20.get())
        {
            entity = new EntityEnderCrystal(this.clientWorldController, d0, d1, d2);
        }
        else if (packetIn.getType() == OBFVAL_21.get())
        {
            entity = new EntityItem(this.clientWorldController, d0, d1, d2);
        }
        else if (packetIn.getType() == OBFVAL_22.get())
        {
            entity = new EntityFallingBlock(this.clientWorldController, d0, d1, d2, Block.getStateById(packetIn.func_149009_m() & OBFVAL_23.get()));
            packetIn.func_149002_g(0);
        }
        ...
        if (entity != null)
        {
            ...
            entity.rotationPitch = (float)(packetIn.getPitch() * OBFVAL_24.get()) / OBFVAL_25.get();
            entity.rotationYaw = (float)(packetIn.getYaw() * OBFVAL_24.get()) / OBFVAL_25.get();
            ...
            {
                if (packetIn.getType() == OBFVAL_4.get())
                {
                ...
                entity.setVelocity((double)packetIn.getSpeedX() / OBFVAL_12.get(), (double)packetIn.getSpeedY() / OBFVAL_12.get(), (double)packetIn.getSpeedZ() / OBFVAL_12.get());
            }
        }
    }
    ...
    {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        Entity entity = new EntityXPOrb(this.clientWorldController, (double)packetIn.getX() / OBFVAL_1.get(), (double)packetIn.getY() / OBFVAL_1.get(), (double)packetIn.getZ() / OBFVAL_1.get(), packetIn.getXPValue());
        entity.serverPosX = packetIn.getX();
        entity.serverPosY = packetIn.getY();
        entity.serverPosZ = packetIn.getZ();
    ...
    {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        double d0 = (double)packetIn.func_149051_d() / OBFVAL_1.get();
        double d1 = (double)packetIn.func_149050_e() / OBFVAL_1.get();
        double d2 = (double)packetIn.func_149049_f() / OBFVAL_1.get();
        Entity entity = null;
        ...
        if (entity != null)
        {
            ...
            this.clientWorldController.c(entity);
        }
    }
    ...
    public void handleEntityVelocity(S12PacketEntityVelocity packetIn)
    {
        ...
        if (entity != null)
        {
            entity.setVelocity(packetIn.getMotionX(), packetIn.getMotionY(), packetIn.getMotionZ());
        }
    }
    ...
    public void handleSpawnPlayer(S0CPacketSpawnPlayer packetIn)
    {
        ...
        double d1 = (double)packetIn.getY() / OBFVAL_1.get();
        double d2 = (double)packetIn.getZ() / OBFVAL_1.get();
        float f = (float)(packetIn.getYaw() * OBFVAL_24.get()) / OBFVAL_25.get();
        float f1 = (float)(packetIn.getPitch() * OBFVAL_24.get()) / OBFVAL_25.get();
        ...
        List<WatchableObject> list = packetIn.func_148944_c();
        ...
        entityotherplayermp.hasPlayerInfo();
    }
    ...
    public void handleEntityTeleport(S18PacketEntityTeleport packetIn)
    {
        ...
        if (entity != null)
        {
            ...
            entity.serverPosY = packetIn.getY();
            entity.serverPosZ = packetIn.getZ();
            double d0 = (double)entity.serverPosX / OBFVAL_1.get();
            double d1 = (double)entity.serverPosY / OBFVAL_1.get();
            double d2 = (double)entity.serverPosZ / OBFVAL_1.get();
            float f = (float)(packetIn.getYaw() * OBFVAL_24.get()) / OBFVAL_25.get();
            float f1 = (float)(packetIn.getPitch() * OBFVAL_24.get()) / OBFVAL_25.get();

            if (Math.abs(entity.posX - d0) < OBFVAL_26.get() && Math.abs(entity.posY - d1) < OBFVAL_27.get() && Math.abs(entity.posZ - d2) < OBFVAL_26.get())
            {
                entity.setPositionAndRotation2(entity.posX, entity.posY, entity.posZ, f, f1, OBFVAL_28.get(), true);
            }
            else
            {
                entity.setPositionAndRotation2(d0, d1, d2, f, f1, OBFVAL_28.get(), true);
            }
    ...
    public void handleEntityMovement(S14PacketEntity packetIn)
    {
        ...
        if (entity != null)
        {
            ...
            double d1 = (double)entity.serverPosY / OBFVAL_1.get();
            double d2 = (double)entity.serverPosZ / OBFVAL_1.get();
            float f = packetIn.func_149060_h() ? (float)(packetIn.func_149066_f() * OBFVAL_24.get()) / OBFVAL_25.get() : entity.rotationYaw;
            float f1 = packetIn.func_149060_h() ? (float)(packetIn.func_149063_g() * OBFVAL_24.get()) / OBFVAL_25.get() : entity.rotationPitch;
            entity.setPositionAndRotation2(d0, d1, d2, f, f1, OBFVAL_28.get(), false);
            entity.onGround = packetIn.getOnGround();
        }
    }
    ...
    public void handlePlayerPosLook(S08PacketPlayerPosLook packetIn)
    {
        ...
        {
            PacketBuffer packetbuffer = new PacketBuffer(Unpooled.buffer(OBFVAL_29.get()));
            packetbuffer.writeVarIntToBuffer(this.teleportId);
            this.netManager.sendPacket(new C17PacketCustomPayload("MC|Tpc", packetbuffer));
            this.teleportId = 0;
        }
    ...
    public void handleMultiBlockChange(S22PacketMultiBlockChange packetIn)
    {
        ...
        for (BlockUpdateData blockupdatedata : packetIn.getChangedBlocks())
        {
    ...
    public void handleChunkData(S21PacketChunkData packetIn)
    {
        ...
        this.clientWorldController.invalidateBlockReceiveRegion(packetIn.getChunkX() << OBFVAL_30.get(), 0, packetIn.getChunkZ() << OBFVAL_30.get(), (packetIn.getChunkX() << OBFVAL_30.get()) + OBFVAL_31.get(), OBFVAL_32.get(), (packetIn.getChunkZ() << OBFVAL_30.get()) + OBFVAL_31.get());
        Chunk chunk = this.clientWorldController.a(packetIn.getChunkX(), packetIn.getChunkZ());
        chunk.fillChunk(packetIn.func_149272_d(), packetIn.getExtractedSize(), packetIn.func_149274_i());
        this.clientWorldController.b(packetIn.getChunkX() << OBFVAL_30.get(), 0, packetIn.getChunkZ() << OBFVAL_30.get(), (packetIn.getChunkX() << OBFVAL_30.get()) + OBFVAL_31.get(), OBFVAL_32.get(), (packetIn.getChunkZ() << OBFVAL_30.get()) + OBFVAL_31.get());

        if (!packetIn.func_149274_i() || !(this.clientWorldController.t instanceof WorldProviderSurface))
        {
    ...
    public void onDisconnect(IChatComponent reason)
    {
        ...
        logger.info("Disconnect reason: " + reason.getUnformattedText());
    ...
    public void handleCollectItem(S0DPacketCollectItem packetIn)
    {
        ...
        if (entity != null)
        {
            ...
            {
                this.clientWorldController.a(entity, "random.orb", OBFVAL_33.get(), ((this.avRandomizer.nextFloat() - this.avRandomizer.nextFloat()) * OBFVAL_34.get() + 1.0F) * OBFVAL_35.get());
            }
            else
            {
                this.clientWorldController.a(entity, "random.pop", OBFVAL_33.get(), ((this.avRandomizer.nextFloat() - this.avRandomizer.nextFloat()) * OBFVAL_34.get() + 1.0F) * OBFVAL_35.get());
            }

            this.gameController.effectRenderer.addEffect(new EntityPickupFX(this.clientWorldController, entity, entitylivingbase, OBFVAL_36.get()));
    ...
    public void handleChat(S02PacketChat packetIn)
    {
        ...
        if (packetIn.getType() == OBFVAL_21.get())
        {
    ...
    public void handleAnimation(S0BPacketAnimation packetIn)
    {
        ...
        if (entity != null)
        {
            ...
            else if (packetIn.getAnimationType() == OBFVAL_21.get())
            {
                EntityPlayer entityplayer = (EntityPlayer)entity;
                entityplayer.wakeUpPlayer(false, false, false);
            }
            else if (packetIn.getAnimationType() == OBFVAL_30.get())
            {
                this.gameController.effectRenderer.emitParticleAtEntity(entity, EnumParticleTypes.CRIT);
            }
            else if (packetIn.getAnimationType() == OBFVAL_29.get())
            {
    ...
    public void handleSpawnMob(S0FPacketSpawnMob packetIn)
    {
        ...
        entitylivingbase.renderYawOffset = entitylivingbase.rotationYawHead = (float)(packetIn.getHeadPitch() * OBFVAL_24.get()) / OBFVAL_25.get();
        ...
        entitylivingbase.motionX = (double)((float)packetIn.getVelocityX() / OBFVAL_37.get());
        entitylivingbase.motionY = (double)((float)packetIn.getVelocityY() / OBFVAL_37.get());
        entitylivingbase.motionZ = (double)((float)packetIn.getVelocityZ() / OBFVAL_37.get());
        this.clientWorldController.addEntityToWorld(packetIn.getEntityID(), entitylivingbase);
        List<WatchableObject> list = packetIn.func_149027_c();
    ...
    {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        this.gameController.theWorld.a(packetIn.getTotalWorldTime());
    ...
    public void handleSpawnPosition(S05PacketSpawnPosition packetIn)
    {
        ...
        this.gameController.theWorld.P().setSpawn(packetIn.getSpawnPos());
    }
    ...
    public void handleEntityStatus(S19PacketEntityStatus packetIn)
    {
        ...
        if (entity != null)
        {
            if (packetIn.getOpCode() == OBFVAL_38.get())
            {
    ...
    public void handleRespawn(S07PacketRespawn packetIn)
    {
        ...
        if (packetIn.getDimensionID() != this.gameController.thePlayer.dimension)
        {
            ...
            Scoreboard scoreboard = this.clientWorldController.Z();
            this.clientWorldController = new WorldClient(this, new WorldSettings(0L, packetIn.getGameType(), false, this.gameController.theWorld.P().isHardcoreModeEnabled(), packetIn.getWorldType()), packetIn.getDimensionID(), packetIn.getDifficulty(), this.gameController.mcProfiler);
    ...
    public void handleSetSlot(S2FPacketSetSlot packetIn)
    {
        ...
        else
        {
            ...
            if (packetIn.func_149175_c() == 0 && packetIn.func_149173_d() >= OBFVAL_39.get() && packetIn.func_149173_d() < OBFVAL_40.get())
            {
                ...
                {
                    packetIn.func_149174_e().animationsToGo = OBFVAL_29.get();
                }

                entityplayer.inventoryContainer.putStackInSlot(packetIn.func_149173_d(), packetIn.func_149174_e());

                if (entityplayer.getItemInUse() != null && entityplayer.getItemInUse() == itemstack && ItemStack.areItemStacksEqual(packetIn.func_149174_e(), itemstack))
                {
                    this.addToSendQueue(new C17PacketCustomPayload("MC|StopUsing", new PacketBuffer(Unpooled.EMPTY_BUFFER)));
    ...
    {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        TileEntity tileentity = this.clientWorldController.s(packetIn.getSignPosition());
    ...
    public void handleUpdateSign(S33PacketUpdateSign packetIn)
    {
        ...
        if (this.gameController.theWorld.e(packetIn.getPos()))
        {
            TileEntity tileentity = this.gameController.theWorld.s(packetIn.getPos());
            ...
            if (tileentity instanceof TileEntitySign)
            {
                ...
                {
                    System.arraycopy(packetIn.getLines(), 0, tileentitysign.signText, 0, OBFVAL_30.get());
                    tileentitysign.p_();
                }
        ...
        {
            this.gameController.thePlayer.addChatMessage(new ChatComponentText("Unable to locate sign at " + packetIn.getPos().n() + ", " + packetIn.getPos().o() + ", " + packetIn.getPos().p()));
        }
    }
    ...
    public void handleUpdateTileEntity(S35PacketUpdateTileEntity packetIn)
    {
        ...
        if (this.gameController.theWorld.e(packetIn.getPos()))
        {
            ...
            if (i == 1 && tileentity instanceof TileEntityMobSpawner || i == OBFVAL_21.get() && tileentity instanceof TileEntityCommandBlock || i == OBFVAL_28.get() && tileentity instanceof TileEntityBeacon || i == OBFVAL_30.get() && tileentity instanceof TileEntitySkull || i == OBFVAL_29.get() && tileentity instanceof TileEntityFlowerPot || i == OBFVAL_41.get() && tileentity instanceof TileEntityBanner)
            {
    ...
    {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        this.gameController.theWorld.c(packetIn.getBlockPosition(), packetIn.getBlockType(), packetIn.getData1(), packetIn.getData2());
    }
    ...
    {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        this.gameController.theWorld.c(packetIn.getBreakerId(), packetIn.getPosition(), packetIn.getProgress());
    }
    ...
    public void handleMapChunkBulk(S26PacketMapChunkBulk packetIn)
    {
        ...
        for (int i = 0; i < packetIn.getChunkCount(); ++i)
        {
            ...
            this.clientWorldController.invalidateBlockReceiveRegion(j << OBFVAL_30.get(), 0, k << OBFVAL_30.get(), (j << OBFVAL_30.get()) + OBFVAL_31.get(), OBFVAL_32.get(), (k << OBFVAL_30.get()) + OBFVAL_31.get());
            Chunk chunk = this.clientWorldController.a(j, k);
            chunk.fillChunk(packetIn.getChunkBytes(i), packetIn.getChunkSize(i), true);
            this.clientWorldController.b(j << OBFVAL_30.get(), 0, k << OBFVAL_30.get(), (j << OBFVAL_30.get()) + OBFVAL_31.get(), OBFVAL_32.get(), (k << OBFVAL_30.get()) + OBFVAL_31.get());
    ...
    public void handleChangeGameState(S2BPacketChangeGameState packetIn)
    {
        ...
        int j = MathHelper.floor_float(f + OBFVAL_36.get());
        ...
        else if (i == OBFVAL_29.get())
        {
            ...
            else if (f == OBFVAL_42.get())
            {
                GuiNewChat guinewchat = this.gameController.ingameGUI.getChatGUI();
                Object[] aobject = new Object[OBFVAL_30.get()];
                aobject[0] = GameSettings.getKeyDisplayString(gamesettings.keyBindForward.getKeyCode());
                aobject[1] = GameSettings.getKeyDisplayString(gamesettings.keyBindLeft.getKeyCode());
                aobject[OBFVAL_21.get()] = GameSettings.getKeyDisplayString(gamesettings.keyBindBack.getKeyCode());
                aobject[OBFVAL_28.get()] = GameSettings.getKeyDisplayString(gamesettings.keyBindRight.getKeyCode());
                guinewchat.printChatMessage(new ChatComponentTranslation("demo.help.movement", aobject));
            }
            else if (f == OBFVAL_43.get())
            {
        ...
        else if (i == OBFVAL_41.get())
        {
            this.clientWorldController.playSound(entityplayer.posX, entityplayer.posY + (double)entityplayer.getEyeHeight(), entityplayer.posZ, "random.successful_hit", OBFVAL_45.get(), OBFVAL_46.get(), false);
        }
        else if (i == OBFVAL_47.get())
        {
            this.clientWorldController.k(f);
        }
        else if (i == OBFVAL_48.get())
        {
            this.clientWorldController.i(f);
        }
        else if (i == OBFVAL_2.get())
        {
            this.clientWorldController.a(EnumParticleTypes.MOB_APPEARANCE, entityplayer.posX, entityplayer.posY, entityplayer.posZ, 0.0D, 0.0D, 0.0D, new int[0]);
    ...
    public void handleEffect(S28PacketEffect packetIn)
    {
        ...
        {
            this.gameController.theWorld.a(packetIn.getSoundType(), packetIn.getSoundPos(), packetIn.getSoundData());
        }
        else
        {
            this.gameController.theWorld.b(packetIn.getSoundType(), packetIn.getSoundPos(), packetIn.getSoundData());
        }
    }
    ...
    public void handleCombatEvent(S42PacketCombatEvent packetIn)
    {
        ...
        if (packetIn.eventType == Event.END_COMBAT)
        {
            long i = (long)(OBFVAL_49.get() * packetIn.field_179772_d / OBFVAL_0.get());
        ...
        else if (packetIn.eventType == Event.ENTITY_DIED)
        {
            ...
            if (entity1 instanceof EntityPlayer)
            {
                ...
                metadataplayerdeath.a(packetIn.deathMessage);
    ...
    {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        this.gameController.theWorld.P().setDifficulty(packetIn.getDifficulty());
        this.gameController.theWorld.P().setDifficultyLocked(packetIn.isDifficultyLocked());
    }
    ...
    {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        packetIn.func_179788_a(this.clientWorldController.af());
    }
    ...
    public void handlePlayerListItem(S38PacketPlayerListItem packetIn)
    {
        ...
        for (AddPlayerData addplayerdata : packetIn.func_179767_a())
        {
            if (packetIn.func_179768_b() == Action.REMOVE_PLAYER)
            {
                this.playerInfoMap.remove(addplayerdata.getProfile().getId());
            }
            else
            {
                NetworkPlayerInfo networkplayerinfo = (NetworkPlayerInfo)this.playerInfoMap.get(addplayerdata.getProfile().getId());

                if (packetIn.func_179768_b() == Action.ADD_PLAYER)
                {
    ...
    public void handleResourcePack(S48PacketResourcePackSend packetIn)
    {
        ...
        else if (this.gameController.getCurrentServerData() != null && this.gameController.getCurrentServerData().getResourceMode() == ServerResourceMode.ENABLED)
        {
            this.netManager.sendPacket(new C19PacketResourcePackStatus(s1, net.minecraft.network.play.client.C19PacketResourcePackStatus.Action.ACCEPTED));
        ...
        else if (this.gameController.getCurrentServerData() != null && this.gameController.getCurrentServerData().getResourceMode() != ServerResourceMode.PROMPT)
        {
            this.netManager.sendPacket(new C19PacketResourcePackStatus(s1, net.minecraft.network.play.client.C19PacketResourcePackStatus.Action.DECLINED));
        }
        else
        {
                    ...
                    NetHandlerPlayClient.this.gameController.displayGuiScreen(new GuiYesNo(new GuiYesNoCallback()
                    {
                        public void confirmClicked(boolean result, int id)
                        {
                            ...
                            if (result)
                            {
                                ...
                                {
                                    NetHandlerPlayClient.this.gameController.getCurrentServerData().setResourceMode(ServerResourceMode.ENABLED);
                                }

                                NetHandlerPlayClient.this.netManager.sendPacket(new C19PacketResourcePackStatus(s1, net.minecraft.network.play.client.C19PacketResourcePackStatus.Action.ACCEPTED));
                            ...
                            else
                            {
                                if (NetHandlerPlayClient.this.gameController.getCurrentServerData() != null)
                                {
                                    NetHandlerPlayClient.this.gameController.getCurrentServerData().setResourceMode(ServerResourceMode.DISABLED);
                                }

                                NetHandlerPlayClient.this.netManager.sendPacket(new C19PacketResourcePackStatus(s1, net.minecraft.network.play.client.C19PacketResourcePackStatus.Action.DECLINED));
                            }
    ...
    public void handleCustomPayload(S3FPacketCustomPayload packetIn)
    {
        ...
        {
            this.gameController.thePlayer.setClientBrand(packetIn.getBufferData().readStringFromBuffer(OBFVAL_50.get()));
        }
        ...
        else if ("MC|Tpc".equals(packetIn.getChannelName()))
        {
            this.teleportId = packetIn.getBufferData().readVarIntFromBuffer();
        }
        else if ("Texteria".equals(packetIn.getChannelName()))
        {
            Texteria.instance.handleTexteriaPacket(packetIn);
        }
        else if ("MiniDot".equals(packetIn.getChannelName()))
        {
            MiniDot.instance.handleMiniDotPacket(packetIn);
        }
        else if ("Ping".equals(packetIn.getChannelName()))
        {
            this.addToSendQueue(new C17PacketCustomPayload("Pong", packetIn.getBufferData()));
        }
    }
    ...
    public void handleScoreboardObjective(S3BPacketScoreboardObjective packetIn)
    {
        ...
        else
        {
            ...
            else if (packetIn.func_149338_e() == OBFVAL_21.get())
            {
    ...
    public void handleUpdateScore(S3CPacketUpdateScore packetIn)
    {
        ...
        if (packetIn.getScoreAction() == net.minecraft.network.play.server.S3CPacketUpdateScore.Action.CHANGE)
        {
        ...
        else if (packetIn.getScoreAction() == net.minecraft.network.play.server.S3CPacketUpdateScore.Action.REMOVE)
        {
    ...
    public void handleTeams(S3EPacketTeams packetIn)
    {
        ...
        if (packetIn.func_149307_h() == 0 || packetIn.func_149307_h() == OBFVAL_21.get())
        {
            ...
            EnumVisible enumvisible = EnumVisible.func_178824_a(packetIn.func_179814_i());
        ...
        if (packetIn.func_149307_h() == 0 || packetIn.func_149307_h() == OBFVAL_28.get())
        {
        ...
        if (packetIn.func_149307_h() == OBFVAL_30.get())
        {
    ...
    public void handleParticles(S2APacketParticles packetIn)
    {
        ...
        if (packetIn.getParticleCount() == 0)
        {
            ...
            try
            {
                this.clientWorldController.a(packetIn.getParticleType(), packetIn.isLongDistance(), packetIn.getXCoordinate(), packetIn.getYCoordinate(), packetIn.getZCoordinate(), d0, d2, d4, packetIn.getParticleArgs());
            }
        ...
        else
        {
            for (int i = 0; i < packetIn.getParticleCount(); ++i)
            {
                ...
                try
                {
                    this.clientWorldController.a(packetIn.getParticleType(), packetIn.isLongDistance(), packetIn.getXCoordinate() + d1, packetIn.getYCoordinate() + d3, packetIn.getZCoordinate() + d5, d6, d7, d8, packetIn.getParticleArgs());
                }
    ...
    public void handleEntityProperties(S20PacketEntityProperties packetIn)
    {
        ...
        if (entity != null)
        {
            ...
            for (Snapshot snapshot : packetIn.func_149441_d())
            {
                IAttributeInstance iattributeinstance = baseattributemap.getAttributeInstanceByName(snapshot.func_151409_a());

                if (iattributeinstance == null)
                {
                    iattributeinstance = baseattributemap.registerAttribute(new RangedAttribute((IAttribute)null, snapshot.func_151409_a(), 0.0D, OBFVAL_51.get(), OBFVAL_52.get()));
                }
    ...
    public void handleEmpty(S4APacketEmpty p_handleEmpty_1_)
    {
    }
    ...
    static
    {
        ...
        ObfValue.endGeneration(new byte[] {(byte) - 20, (byte)119, (byte) - 26, (byte) - 21, (byte)57, (byte) - 34, (byte) - 30, (byte)108});
    }
}

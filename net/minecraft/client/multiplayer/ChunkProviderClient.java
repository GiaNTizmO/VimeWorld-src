...
public class ChunkProviderClient implements IChunkProvider
{
    ...
    private Chunk lastUsedChunk = null;
    ...
    private LongHashMap chunkMapping = new LongHashMap()
    {
        ...
        {
            Chunk chunk = ChunkProviderClient.this.lastUsedChunk;
            return chunk != null && chunk.hashedLoc == p_76164_1_ ? chunk : (ChunkProviderClient.this.lastUsedChunk = (Chunk)super.getValueByKey(p_76164_1_));
        }
        public Object remove(long p_76159_1_)
        {
            Chunk chunk = ChunkProviderClient.this.lastUsedChunk;

            if (chunk != null && chunk.hashedLoc == p_76159_1_)
            {
                ChunkProviderClient.this.lastUsedChunk = null;
            }
    ...
    {
        return this.provideChunk(blockPosIn.n() >> 4, blockPosIn.p() >> 4);
    }
}

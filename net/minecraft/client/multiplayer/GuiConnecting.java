...
public class GuiConnecting extends GuiScreen
{
    ...
    private ServerAddress getConnectAddress(String p_getConnectAddress_1_)
    {
        if (p_getConnectAddress_1_.equals("vimeworld.net") || p_getConnectAddress_1_.equals("vimeworld.net:25565"))
        {
            ...
            try
            {
                httpurlconnection = (HttpURLConnection)(new URL("https://mg-balancer.vimeworld.ru")).openConnection();
        ...
        (new Thread("Server Connector #" + CONNECTION_ID.incrementAndGet())
        {
            public void run()
            {
                ...
                try
                {
                    ...
                    GuiConnecting.this.networkManager.sendPacket(new C00Handshake(47, s, serveraddress.getPort(), EnumConnectionState.LOGIN));
                ...
                catch (Exception exception)
                {
                    ...
                    if (inetaddress != null)
                    {
                        String s2 = inetaddress.toString() + ":" + serveraddress.getPort();
                        s1 = s1.replaceAll(s2, "");
                    }

                    GuiConnecting.this.mc.displayGuiScreen(new GuiDisconnected(GuiConnecting.this.previousGuiScreen, "connect.failed", new ChatComponentTranslation("disconnect.genericReason", new Object[] {s1})));
                }
            }
        }).start();
    }

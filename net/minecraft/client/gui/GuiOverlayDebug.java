...
public class GuiOverlayDebug extends Gui
{
    ...
    protected List<String> call()
    {
        ...
        {
            return Lists.newArrayList(new String[] {"Minecraft 1.8.8 (VimeWorld: " + this.mc.getSession().getUsername() + ")", this.mc.debug, this.mc.renderGlobal.getDebugInfoRenders(), this.mc.renderGlobal.getDebugInfoEntities(), "P: " + this.mc.effectRenderer.getStatistics() + ". T: " + this.mc.theWorld.z(), this.mc.theWorld.A(), "", String.format("Chunk-relative: %d %d %d", new Object[]{Integer.valueOf(blockpos.n() & 15), Integer.valueOf(blockpos.o() & 15), Integer.valueOf(blockpos.p() & 15)})});
        }
        else
        {
            ...
            String s1 = "";
            Element2D element2d = Texteria.instance.gui.getElement("vn.s");
            ...
            if (this.mc.theWorld != null && this.mc.theWorld.e(blockpos))
            {
                Chunk chunk = this.mc.theWorld.f(blockpos);
                arraylist.add("Biome: " + chunk.getBiome(blockpos, this.mc.theWorld.v()).biomeName);
                ...
                DifficultyInstance difficultyinstance = this.mc.theWorld.E(blockpos);

                if (this.mc.isIntegratedServerRunning() && this.mc.getIntegratedServer() != null)
                {
                    EntityPlayerMP entityplayermp = this.mc.getIntegratedServer().ap().getPlayerByUUID(this.mc.thePlayer.getUniqueID());
                ...
                arraylist.add(String.format("Local Difficulty: %.2f (Day %d)", new Object[] {Float.valueOf(difficultyinstance.getAdditionalDifficulty()), Long.valueOf(this.mc.theWorld.L() / 24000L)}));
            }
            ...
            if (this.mc.objectMouseOver != null && this.mc.objectMouseOver.typeOfHit == MovingObjectType.BLOCK && this.mc.objectMouseOver.getBlockPos() != null)
            {
                ...
                arraylist.add(String.format("Looking at: %d %d %d", new Object[] {Integer.valueOf(blockpos1.n()), Integer.valueOf(blockpos1.o()), Integer.valueOf(blockpos1.p())}));
            }
    ...
    protected List<String> getDebugInfoRight()
    {
        ...
        else
        {
            if (this.mc.objectMouseOver != null && this.mc.objectMouseOver.typeOfHit == MovingObjectType.BLOCK && this.mc.objectMouseOver.getBlockPos() != null)
            {
                ...
                if (this.mc.theWorld.G() != WorldType.DEBUG_WORLD)
                {
                    iblockstate = iblockstate.getBlock().getActualState(iblockstate, this.mc.theWorld, blockpos);
                }

                arraylist.add("");
                arraylist.add(String.valueOf(Block.blockRegistry.c(iblockstate.getBlock())));
                Entry entry;
                String s;

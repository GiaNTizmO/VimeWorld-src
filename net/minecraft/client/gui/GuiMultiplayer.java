...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
        ...
        {
            this.serverListSelector.a(this.width, this.height, 32, this.height - 64);
        }
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.enabled)
        {
            IGuiListEntry iguilistentry = this.serverListSelector.func_148193_k() < 0 ? null : this.serverListSelector.getListEntry(this.serverListSelector.func_148193_k());
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException
    {
        ...
        IGuiListEntry iguilistentry = i < 0 ? null : this.serverListSelector.getListEntry(i);
            ...
            if (keyCode == 200)
            {
                if (isShiftKeyDown())
                {
                    if (i > 0 && iguilistentry instanceof ServerListEntryNormal)
                    {
                        ...
                        this.serverListSelector.h(-this.serverListSelector.r());
                        this.serverListSelector.func_148195_a(this.savedServerList);
                    }
                }
                else if (i > 0)
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.serverListSelector.a(mouseX, mouseY, partialTicks);
    ...
    public void connectToSelected()
    {
        ...
        {
            LanServer lanserver = ((ServerListEntryLanDetected)iguilistentry).getLanServer();
    ...
    public void selectServer(int index)
    {
        ...
        IGuiListEntry iguilistentry = index < 0 ? null : this.serverListSelector.getListEntry(index);
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException
    {
        ...
        this.serverListSelector.b(mouseX, mouseY, mouseButton);
    }
    ...
    protected void mouseReleased(int mouseX, int mouseY, int state)
    {
        ...
        this.serverListSelector.c(mouseX, mouseY, state);
    }

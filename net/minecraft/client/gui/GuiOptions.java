...
import net.xtrafrancyz.mods.pvp.gui.GuiPvpSettings;
...
public class GuiOptions extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
        ...
        {
            EnumDifficulty enumdifficulty = this.mc.theWorld.aa();
            ...
            if (this.mc.isSingleplayer() && !this.mc.theWorld.P().isHardcoreModeEnabled())
            {
                ...
                this.field_175356_r.func_175229_b(this.mc.theWorld.P().isDifficultyLocked());
        ...
        this.buttonList.add(new GuiButton(107, this.width / 2 + 5, this.height / 6 + 72 - 6, 150, 20, "\u041d\u0430\u0441\u0442\u0440\u043e\u0439\u043a\u0438 PvP \u043c\u043e\u0434\u0430"));
    ...
    public void confirmClicked(boolean result, int id)
    {
        ...
        {
            this.mc.theWorld.P().setDifficultyLocked(true);
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.enabled)
        {
            ...
            if (button.id == 108)
            {
                this.mc.theWorld.P().setDifficulty(EnumDifficulty.getDifficultyEnum(this.mc.theWorld.aa().getDifficultyId() + 1));
                this.field_175357_i.displayString = this.func_175355_a(this.mc.theWorld.aa());
            }

            if (button.id == 109)
            {
                this.mc.displayGuiScreen(new GuiYesNo(this, (new ChatComponentTranslation("difficulty.lock.title", new Object[0])).d(), (new ChatComponentTranslation("difficulty.lock.question", new Object[] {new ChatComponentTranslation(this.mc.theWorld.P().getDifficulty().getDifficultyResourceKey(), new Object[0])})).d(), 109));
            }
            ...
            {
                this.mc.gameSettings.saveOptions();
                this.mc.displayGuiScreen(new GuiPvpSettings(this));
            }
        }
    }

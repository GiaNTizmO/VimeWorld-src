...
public class Bootstrap
{
    ...
    {
        BlockDispenser.dispenseBehaviorRegistry.a(Items.arrow, new BehaviorProjectileDispense()
        {
        ...
        BlockDispenser.dispenseBehaviorRegistry.a(Items.egg, new BehaviorProjectileDispense()
        {
            protected IProjectile getProjectileEntity(World worldIn, IPosition position)
            {
        ...
        BlockDispenser.dispenseBehaviorRegistry.a(Items.snowball, new BehaviorProjectileDispense()
        {
            protected IProjectile getProjectileEntity(World worldIn, IPosition position)
            {
        ...
        BlockDispenser.dispenseBehaviorRegistry.a(Items.experience_bottle, new BehaviorProjectileDispense()
        {
            protected IProjectile getProjectileEntity(World worldIn, IPosition position)
            {
        ...
        BlockDispenser.dispenseBehaviorRegistry.a(Items.potionitem, new IBehaviorDispenseItem()
        {
            ...
            public ItemStack dispense(IBlockSource source, final ItemStack stack)
            {
                ...
                }).a(source, stack): this.field_150843_b.dispense(source, stack);
            }
        });
        BlockDispenser.dispenseBehaviorRegistry.a(Items.spawn_egg, new BehaviorDefaultDispenseItem()
        {
            public ItemStack dispenseStack(IBlockSource source, ItemStack stack)
            {
                EnumFacing enumfacing = BlockDispenser.getFacing(source.getBlockMetadata());
                double d0 = source.getX() + (double)enumfacing.getFrontOffsetX();
                double d1 = (double)((float)source.getBlockPos().o() + 0.2F);
                double d2 = source.getZ() + (double)enumfacing.getFrontOffsetZ();
                Entity entity = ItemMonsterPlacer.spawnCreature(source.i(), stack.getMetadata(), d0, d1, d2);
        ...
        BlockDispenser.dispenseBehaviorRegistry.a(Items.fireworks, new BehaviorDefaultDispenseItem()
        {
            public ItemStack dispenseStack(IBlockSource source, ItemStack stack)
            {
                EnumFacing enumfacing = BlockDispenser.getFacing(source.getBlockMetadata());
                ...
                double d1 = (double)((float)source.getBlockPos().o() + 0.2F);
                double d2 = source.getZ() + (double)enumfacing.getFrontOffsetZ();
                EntityFireworkRocket entityfireworkrocket = new EntityFireworkRocket(source.i(), d0, d1, d2, stack);
                source.i().spawnEntityInWorld(entityfireworkrocket);
                stack.splitStack(1);
                return stack;
            }
            protected void playDispenseSound(IBlockSource source)
            {
                source.i().playAuxSFX(1002, source.getBlockPos(), 0);
            }
        });
        BlockDispenser.dispenseBehaviorRegistry.a(Items.fire_charge, new BehaviorDefaultDispenseItem()
        {
            public ItemStack dispenseStack(IBlockSource source, ItemStack stack)
            {
                EnumFacing enumfacing = BlockDispenser.getFacing(source.getBlockMetadata());
            ...
            protected void playDispenseSound(IBlockSource source)
            {
                source.i().playAuxSFX(1009, source.getBlockPos(), 0);
            }
        });
        BlockDispenser.dispenseBehaviorRegistry.a(Items.boat, new BehaviorDefaultDispenseItem()
        {
            ...
            protected void playDispenseSound(IBlockSource source)
            {
                source.i().playAuxSFX(1000, source.getBlockPos(), 0);
            }
        });
        IBehaviorDispenseItem ibehaviordispenseitem = new BehaviorDefaultDispenseItem()
        {
            ...
            public ItemStack dispenseStack(IBlockSource source, ItemStack stack)
            {
                ...
                if (itembucket.tryPlaceContainedLiquid(source.i(), blockpos))
                {
        ...
        BlockDispenser.dispenseBehaviorRegistry.a(Items.lava_bucket, ibehaviordispenseitem);
        BlockDispenser.dispenseBehaviorRegistry.a(Items.water_bucket, ibehaviordispenseitem);
        BlockDispenser.dispenseBehaviorRegistry.a(Items.bucket, new BehaviorDefaultDispenseItem()
        {
        ...
        BlockDispenser.dispenseBehaviorRegistry.a(Items.flint_and_steel, new BehaviorDefaultDispenseItem()
        {
            ...
            protected void playDispenseSound(IBlockSource source)
            {
                ...
                {
                    source.i().playAuxSFX(1001, source.getBlockPos(), 0);
                }
            }
        });
        BlockDispenser.dispenseBehaviorRegistry.a(Items.dye, new BehaviorDefaultDispenseItem()
        {
        ...
        BlockDispenser.dispenseBehaviorRegistry.a(Item.getItemFromBlock(Blocks.tnt), new BehaviorDefaultDispenseItem()
        {
            protected ItemStack dispenseStack(IBlockSource source, ItemStack stack)
            {
                World world = source.i();
        ...
        BlockDispenser.dispenseBehaviorRegistry.a(Items.skull, new BehaviorDefaultDispenseItem()
        {
            ...
            protected ItemStack dispenseStack(IBlockSource source, ItemStack stack)
            {
                ...
                if (world.isAirBlock(blockpos) && blockskull.canDispenserPlace(world, blockpos, stack))
                {
                    if (!world.isRemote)
                    {
                        world.setBlockState(blockpos, blockskull.Q().withProperty(BlockSkull.FACING, EnumFacing.UP), 3);
        ...
        BlockDispenser.dispenseBehaviorRegistry.a(Item.getItemFromBlock(Blocks.pumpkin), new BehaviorDefaultDispenseItem()
        {
            ...
            protected ItemStack dispenseStack(IBlockSource source, ItemStack stack)
            {
                ...
                if (world.isAirBlock(blockpos) && blockpumpkin.canDispenserPlace(world, blockpos))
                {
                    if (!world.isRemote)
                    {
                        world.setBlockState(blockpos, blockpumpkin.Q(), 3);
                    }

...
public class Rectangle extends Element2D
{
    ...
    public Rectangle(ByteMap params, int defaultSize)
    {
        ...
        {
            this.width = new FValue(params.getFloat("size", (float)defaultSize), this.anim);
            this.height = new FValue(this.width.orig, this.anim);
        }
        else
        {
            this.width = new FValue(params.getFloat("width", (float)defaultSize), this.anim);
            this.height = new FValue(params.getFloat("height", (float)defaultSize), this.anim);
        }
    ...
    {
        super(id);
        this.width = new FValue(width, this.anim);
        this.height = new FValue(height, this.anim);
    }

...
public abstract class Element2D extends Element implements Element2DWrapper
{
    ...
    public Element2D(String id)
    {
        ...
        this.x = new FValue(0.0F, Easing.EASE_IN_SINE, 255);
        this.y = new FValue(0.0F, Easing.EASE_IN_SINE, 255);
        this.scaleX = new FValue(1.0F, Easing.EASE_IN_SINE, 255);
        this.scaleY = new FValue(1.0F, Easing.EASE_IN_SINE, 255);
        this.rotate = new AngleFValue(0.0F, Easing.EASE_IN_SINE, 255);
        this.pos = null;
        this.attach = null;
    ...
    public Element2D(ByteMap params)
    {
        ...
        this.script = params.getString("script");
        ...
        if (this.script != null)
        {
            ...
            try
            {
                compiledscript = Texteria.instance.scriptManager.compile(this.script);
            }
            catch (ScriptException scriptexception1)
            {
                Texteria.log.warn((String)("Could not compile script \'" + this.script + "\'. Scripts will be disabled for the element \'" + this.id + "\'"), (Throwable)scriptexception1);
                return;
            }
            ...
            {
                Texteria.log.warn((String)("An error occurred while executing a script \'" + this.script + "\'. Scripts will be disabled for the element \'" + this.id + "\'"), (Throwable)scriptexception);

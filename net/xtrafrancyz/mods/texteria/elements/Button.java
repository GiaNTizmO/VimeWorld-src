...
public class Button extends Rectangle
{
    ...
    {
        super(fixLegacyFieldNames(params));
        ...
        this.hoverColor = params.getInt("hc", alterBrightness(this.color.orig, -20));
        this.textColor = params.getInt("tc", -1);
    ...
    public void render(long time)
    {
        ...
        TRenderUtil.drawRect(0.0D, (double)f3, (double)f1, (double)(f2 - f3), this.setAlphaToBaseColor(this.hoverColor));
        this.font.drawStringWithShadow(this.text, (f1 - (float)this.textWidth) / 2.0F, (f2 - (float)this.font.FONT_HEIGHT) / 2.0F, this.setAlphaToBaseColor(this.textColor));
    }
    ...
    private static ByteMap fixLegacyFieldNames(ByteMap map)
    {

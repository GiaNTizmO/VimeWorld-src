...
public class TexteriaGui implements IContainer
{
    ...
    public final List<GuiElementWrapper> persistentElements;
    ...
    public void addPersistentElement(GuiElementWrapper c)
    {
        this.byId.put(c.element.id, c);
    ...
    public void removePersistentElement(String id)
    {
    ...
    public void render(GuiRenderLayer layer)
    {
        if (!this.mc.gameSettings.hideGUI)
        {
            ...
            this.mc.theWorld.B.startSection("TexteriaGui");

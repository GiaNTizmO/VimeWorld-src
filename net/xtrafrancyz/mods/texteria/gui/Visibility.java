...
public class Visibility
{
    ...
    public Visibility(ByteMap[] maps)
    {
        ...
        for (ByteMap bytemap : maps)
        {
            ...
            switch (b0)
            {
                ...
                case 2:
                    String s1 = bytemap.getString("name", "").toLowerCase(Locale.US);
    ...
    {
        private Visibility.GuiSelector.Type type;
    ...
    public static class InventorySelector extends Visibility.Selector
    {
        ...
        public boolean acceptable(Minecraft mc, GuiElementWrapper wrapper)
        {
            return mc.currentScreen instanceof GuiChest ? ((GuiChest)mc.currentScreen).lowerChestInventory.f_().getUnformattedText().equals(this.name) : false;
        }
    }

...
public class Particle
{
    ...
    private static final MutableBlockPos BLOCK_POS = new MutableBlockPos();
    public float motX;
    public float motY;
    public float motZ;
    public float posX;
    ...
    public Particle(ParticleConfig config)
    {
        ...
        this.image = Image.createImage(new Image.ImageDescriptor(config.image, Image.TextureRenderHint.CLAMP), config.imageData, true);

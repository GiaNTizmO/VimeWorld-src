...
public class Line extends Element3D
{
    ...
    public FValue width = new FValue(0.0F, Easing.EASE_IN_SINE, 255);
    ...
    public Line(ByteMap params)
    {
        ...
        {
            this.points.add(new ValueVector3f(Float.intBitsToFloat(aint[i]), Float.intBitsToFloat(aint[i + 1]), Float.intBitsToFloat(aint[i + 2]), this.editDuration, this.editEasing));
        }
    ...
    private void recalculateBoundingBox()
    {
        ...
        for (ValueVector3f valuevector3f : this.points)
        {
            ...
            else if (valuevector3f.x.render > f1)
            {
            ...
            else if (valuevector3f.y.render > f3)
            {
            ...
            else if (valuevector3f.z.render > f5)
            {
    ...
    public void edit(ByteMap data)
    {
        ...
        if (abytemap != null)
        {
            for (ByteMap bytemap : abytemap)
            {
                ...
                {
                    case 0:
                        ValueVector3f valuevector3f = new ValueVector3f(bytemap.getFloat("x"), bytemap.getFloat("y"), bytemap.getFloat("z"), this.editDuration, this.editEasing);

...
{
    private MModelRenderer top;
    private MModelRenderer mid;
    private MModelRenderer down;
    private MModelRenderer rear1;
    private MModelRenderer rear2;
    private MModelRenderer lear1;
    private MModelRenderer lear2;
    private MModelRenderer rhand1;
    private MModelRenderer rhand2;
    private MModelRenderer lhand1;
    private MModelRenderer lnahd2;
    private MModelRenderer rleg1;
    private MModelRenderer rleg2;
    private MModelRenderer lleg1;
    private MModelRenderer lleg2;
    private MModelRenderer body;
    private MModelRenderer body2;
    private MModelRenderer body3;
    private MModelRenderer handle;
    private MModelRenderer handlebot;
    private MModelRenderer topborder1;
    private MModelRenderer topborder2;
    private MModelRenderer topborder3;
    private MModelRenderer topborder4;
    private MModelRenderer grip1;
    private MModelRenderer grip2;
    private MModelRenderer base;
    private MModelRenderer handletop1;
    private MModelRenderer base1;

...
public class PlayerPet extends BasePet
{
    ...
    private static ModelRenderer hair;
    ...
    public PlayerPet(String username, String texture)
    {
        ...
        if (hair == null)
        {
            ...
            hair.mirror = true;
            ((MModelRenderer)hair).setDynamic(true);
    ...
    protected void processMotion(ModelPlayer modelPlayer, EntityPlayer player, float time)
    {
        ...
        MModelRenderer mmodelrenderer = (MModelRenderer)hair;
    ...
    {
        super.renderModels();
        GlStateManager.scale(1.1F, 1.15F, 1.1F);
    ...
    public void renderAsItem(float time)
    {
        ...
        MModelRenderer mmodelrenderer = (MModelRenderer)hair;
        mmodelrenderer.rotationX = 0.0F;
        mmodelrenderer.rotationY = 0.0F;
        mmodelrenderer.rotationZ = 0.0F;

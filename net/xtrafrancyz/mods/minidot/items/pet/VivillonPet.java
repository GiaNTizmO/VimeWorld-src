...
public class VivillonPet extends BasePet
{
    ...
    private MModelRenderer leftLeg;
    private MModelRenderer rightLeg;
    private MModelRenderer leftHand;
    private MModelRenderer rightHand;
    private MModelRenderer head;
    private MModelRenderer rightStick;
    private MModelRenderer leftStick;
    private MModelRenderer leftWing;
    private MModelRenderer rightWing;

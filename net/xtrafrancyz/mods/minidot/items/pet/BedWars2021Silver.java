...
public class BedWars2021Silver extends BasePet
{
    ...
    public BedWars2021Silver()
    {
        ...
        this.Sword2.setRotationPoint(-0.1F, -20.9F, -5.4F);
        this.setRotation(this.Sword2, 0.0F, 1.5708F, 0.0F);
        this.Person.addChild(this.Sword2);
        this.Sword2.cubeList.add(new ModelBox(this.Sword2, 25, 36, -0.4174F, 4.6146F, -1.9936F, 1, 1, 4, -0.1F, false));
        this.Sword2.cubeList.add(new ModelBox(this.Sword2, 0, 0, -0.4174F, 5.3146F, -0.4936F, 1, 3, 1, -0.15F, false));
        this.Sword2.cubeList.add(new ModelBox(this.Sword2, 48, 48, -0.4174F, -6.8854F, -1.4936F, 1, 12, 3, -0.4F, false));
        this.Sword = new MModelRenderer(this);
        this.Sword.setRotationPoint(-0.1F, -20.9F, -5.4F);
        this.setRotation(this.Sword, 0.0F, 1.5708F, 0.0F);
        this.Person.addChild(this.Sword);
        this.Sword.cubeList.add(new ModelBox(this.Sword, 25, 36, -0.4174F, 4.6146F, -1.9936F, 1, 1, 4, -0.1F, false));
        this.Sword.cubeList.add(new ModelBox(this.Sword, 0, 0, -0.4174F, 5.3146F, -0.4936F, 1, 3, 1, -0.15F, false));
        this.Sword.cubeList.add(new ModelBox(this.Sword, 48, 48, -0.4174F, -6.8854F, -1.4936F, 1, 12, 3, -0.4F, false));
        ...
        this.LeftHand.setRotationPoint(-5.9F, 1.45F, 0.15F);
        this.setRotation(this.LeftHand, 1.0037F, -0.8015F, -0.7358F);
        ...
        this.RightHand.setRotationPoint(5.3F, 1.3F, -0.8F);
        this.setRotation(this.RightHand, 0.6852F, 0.6701F, 0.5521F);
        ...
        this.LeftLeg.setRotationPoint(2.6F, -15.8F, 0.45F);
        ...
        this.setRotation(this.RightLeg, -0.1075F, 0.2219F, 0.3218F);
        ...
        BBAnimationLoader bbanimationloader = new BBAnimationLoader(new ResourceLocation("minidot", "pets/BedWars2021Silver.animation.json"));
        this.anim = bbanimationloader.mustGet("animation.tournament.scarf", this);
        this.setTexture(new ResourceLocation("minidot", "pets/BedWars2021Silver.png"));
    }
    ...
    {
        return "\u0421\u0435\u0440\u0435\u0431\u0440\u044f\u043d\u043d\u0430\u044f \u043a\u0440\u043e\u0432\u0430\u0442\u043a\u0430 2021";
    }

    public List<String> getDescription()
    {
        return Collections.<String>singletonList("\u0417\u0430 \u0432\u0442\u043e\u0440\u043e\u0435 \u043c\u0435\u0441\u0442\u043e \u0432 \u0442\u0443\u0440\u043d\u0438\u0440\u0435 " + EnumChatFormatting.AQUA + "BedWars Hard [\u0417\u0438\u043c\u0430 2021]");
    }
}

...
public class UnluckyCatPet extends BasePet
{
    ...
    private MModelRenderer Head;
    private MModelRenderer Left_eye;
    private MModelRenderer Right_eye;
    private MModelRenderer Nose;
    private MModelRenderer Tooth1;
    private MModelRenderer Tooth2;
    private MModelRenderer Tongue;
    private MModelRenderer Left_ear;
    private MModelRenderer Right_ear;
    private MModelRenderer Snout_top;
    private MModelRenderer Snout_bottom;
    private MModelRenderer Snout_left;
    private MModelRenderer Snout_right;
    private MModelRenderer FRLeg;
    private MModelRenderer FLLeg;
    private MModelRenderer BLLeg;
    private MModelRenderer BRLeg;
    private MModelRenderer Tail;

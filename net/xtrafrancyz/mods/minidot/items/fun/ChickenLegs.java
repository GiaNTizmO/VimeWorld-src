...
public class ChickenLegs extends BaseItem
{
    ...
    private static ResourceLocation[] textures = new ResourceLocation[] {new ResourceLocation("minidot", "body/chicken_legs_1.png"), new ResourceLocation("minidot", "body/chicken_legs_2.png"), new ResourceLocation("minidot", "body/chicken_legs_3.png"), new ResourceLocation("minidot", "body/chicken_legs_4.png")};
    ...
    public void renderAsItem(float time)
    {
        ...
        GL11.glTranslatef(0.0F, -0.42F, 0.4F);

...
public class MGuiMain extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(this.btnExit = new GuiButton(-52, this.guiLeft + 10, this.guiTop + this.windowHeight - 23, 236, 18, "\u041e\u0431\u0440\u0430\u0442\u043d\u043e \u0432 \u0438\u043d\u0432\u0435\u043d\u0442\u0430\u0440\u044c"));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawTexturedModalRect(this.guiLeft, this.guiTop, 0, 0, this.windowWidth, this.windowHeight);

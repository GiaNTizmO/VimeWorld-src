...
public class RPMiniGames implements RPGenerator
{
    ...
    public DiscordRichPresence generate()
    {
        ...
        String s1 = null;
        element2d = Texteria.instance.gui.getElement("vn.n");
        ...
        else
        {
            ...
            {
                discordrichpresence.largeImageKey = "logo";
                discordrichpresence.largeImageText = "VimeWorld.ru";
            }
            else
            {
                discordrichpresence.smallImageKey = "logo";
                discordrichpresence.smallImageText = "VimeWorld.ru";
            }
        }
